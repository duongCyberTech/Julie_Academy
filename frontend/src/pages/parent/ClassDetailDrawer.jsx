        ...
        >
          <Box>
            <Chip
              ...
              size="small"
              variant="filled"
              sx={{ mb: 1.5, fontWeight: 600, borderRadius: "8px" }}
            />
            <Typography
              variant="h5"
              fontWeight="bold"
      ...
      >
        ...
        >
          ...
          >
            ...
            <Chip
              size="small"
              label={dayjs(startat).format("DD/MM/YYYY")}
          ...
          {schedule && schedule.length > 0 ? (
            <Stack spacing={1.5}>
              {schedule.map((slot) => (
                ...
                >
                  <Typography fontWeight="600" color="#c2410c">
                    {getDayName(slot.meeting_date)}
                  </Typography>
                  <Chip
        ...
        >
          {/* Gộp Tiêu đề và Sĩ số lên cùng một hàng */}
          <Stack
            direction="row"
            justifyContent="space-between"
            alignItems="center"
          ...
          >
            ...
            <Chip
              label={
                <span>
                  Sĩ số: <strong>{nb_of_student}</strong> học viên
                </span>
              }
              size="small"
              sx={{
