...
function StudentEnrollPage() {
    ...
    // Kiểm tra trạng thái đăng ký của user hiện tại với lớp học
    ...
    // Hàm render nút hành động dựa trên trạng thái đăng ký
            ...
            return (
                <Tooltip title="Nhấn vào đây để vào lớp" arrow placement="top">
                    <Chip 
                        ...
                        color="success" 
                        variant="outlined" 
                        sx={{ fontWeight: 600, bgcolor: '#ecfdf5', border: 'none', color: '#059669', cursor: 'pointer' }} 
                    />
                </Tooltip>
            );
        }
