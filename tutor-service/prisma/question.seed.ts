...
const createAnswersData = (answers) => {
  return answers.map((ans, index) => ({
    ...
    explaination: ans.explaination
      ? formatQuillContent(ans.explaination)
      : null,
  }));
};
...
async function main() {
  ...
  const questionsData = [
    ...
    // =================================================================
    {
      ...
      explaination:
        'Đây là ký hiệu toán học cơ bản cho bất đẳng thức không nghiêm ngặt.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        ...
        {
          content: '$a$ lớn hơn hoặc bằng $b$',
          is_correct: true,
          explaination:
            'Ký hiệu $\\ge$ có nghĩa là "lớn hơn hoặc bằng", hay còn gọi là "không nhỏ hơn".',
        },
      ],
    },
    {
      content:
        'Cho bất đẳng thức $a < b$. Khẳng định nào sau đây là <b>đúng</b> khi cộng số $c$ vào hai vế?',
      explaination:
        'Theo tính chất liên hệ giữa thứ tự và phép cộng, khi cộng cùng một số vào hai vế, ta được BĐT mới cùng chiều.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$a+c > b+c$',
          is_correct: false,
          explaination: 'Bất đẳng thức đã bị đổi chiều.',
        },
        {
          content: '$a+c < b+c$',
          is_correct: true,
          explaination: 'BĐT mới cùng chiều với BĐT đã cho.',
        },
        {
          content: '$a+c = b+c$',
          is_correct: false,
          explaination: 'Chỉ xảy ra khi $a=b$.',
        },
        {
          content: '$a+c \\ge b+c$',
          is_correct: false,
          explaination: 'Sai ký hiệu.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          content: '$x+5 > 15$',
          is_correct: true,
          explaination: 'Vì $x > 10 \\implies x+5 > 10+5 \\implies x+5 > 15$.',
        },
    ...
    }, // --- Medium ---
    {
      ...
      explaination:
        'Khi nhân cả hai vế của BĐT với một số âm, ta phải đổi chiều BĐT.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$a-2 < b-2$',
          is_correct: false,
          explaination: 'Đúng, vì cộng hai vế với -2.',
        },
        {
          content: '$5a < 5b$',
          is_correct: false,
          explaination: 'Đúng, vì nhân hai vế với 5 (số dương).',
        },
        {
          content: '$-3a > -3b$',
          is_correct: false,
          explaination: 'Đúng, vì nhân hai vế với -3 (số âm) và đổi chiều BĐT.',
        },
        {
          content: '$-a < -b$',
          is_correct: true,
          explaination:
            'Sai. Vì $a < b$, nhân hai vế với -1 phải đổi chiều thành $-a > -b$.',
        },
      ],
    },
    {
      ...
      explaination:
        'Ta có $A = 1 + \\frac{1}{2023}$ và $B = 1 + \\frac{1}{2024}$. So sánh hai phân số $\\frac{1}{2023}$ và $\\frac{1}{2024}$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$A < B$',
          is_correct: false,
          explaination: 'Phân số có mẫu nhỏ hơn thì lớn hơn.',
        },
        {
          content: '$A > B$',
          is_correct: true,
          explaination:
            'Vì $2023 < 2024 \\implies \\frac{1}{2023} > \\frac{1}{2024} \\implies 1 + \\frac{1}{2023} > 1 + \\frac{1}{2024} \\implies A > B$.',
        },
    ...
    {
      content:
        'Cho $a > b$. Chọn các khẳng định <b>đúng</b> (chọn nhiều đáp án).',
      explaination:
        'Áp dụng các tính chất liên hệ giữa thứ tự và phép cộng/nhân.',
      level: DifficultyLevel.medium,
      type: QuestionType.multiple_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$a+c > b+c$',
          is_correct: true,
          explaination: 'Tính chất liên hệ với phép cộng.',
        },
        {
          content: '$a-b > 0$',
          is_correct: true,
          explaination: 'Định nghĩa của bất đẳng thức $a > b$.',
        },
        {
          content: '$2a > 2b$',
          is_correct: true,
          explaination: 'Nhân hai vế với 2 (số dương).',
        },
        {
          content: '$-a > -b$',
          is_correct: false,
          explaination:
            'Nhân với -1 (số âm) phải đổi chiều BĐT thành $-a < -b$.',
        },
      ],
    }, // --- Hard ---
    {
      content:
        'Bất đẳng thức $x^2 + y^2 \\ge 2xy$ đúng với mọi $x, y$. Dấu "=" (bằng) xảy ra khi nào?',
      explaination:
        'BĐT tương đương $(x-y)^2 \\ge 0$. Dấu "=" xảy ra khi $(x-y)^2 = 0$.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        ...
        { content: '$x < y$', is_correct: false },
        {
          content: '$x = y$',
          is_correct: true,
          explaination: 'Dấu "=" xảy ra khi $x-y=0$, tức là $x=y$.',
        },
        {
          content: '$x = 0$ và $y = 0$',
          is_correct: false,
          explaination: 'Đây là trường hợp riêng, $x=y=3$ vẫn đúng.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Vì $a > b > 0$, nhân hai vế với $\\frac{1}{ab} > 0$ ta được $\\frac{a}{ab} > \\frac{b}{ab} \\implies \\frac{1}{b} > \\frac{1}{a}$.',
        },
        {
          content: '$\\frac{1}{a} < \\frac{1}{b}$',
          is_correct: true,
          explaination:
            'Vì $a > b > 0$, áp dụng tính chất $a > b \\implies \\frac{1}{a} < \\frac{1}{b}$ (với a, b cùng dương).',
        },
        { content: '$\\frac{1}{a} = \\frac{1}{b}$', is_correct: false },
        {
          ...
          is_correct: false,
          explaination:
            'Nhân hai vế $a>b$ với $a>0$ ta được $a^2 > ab$. Nhân hai vế $a>b$ với $b>0$ ta được $ab > b^2$. Theo tính chất bắc cầu: $a^2 > ab > b^2 \\implies a^2 > b^2$.',
        },
      ],
    },
    {
      content:
        'Cho $a \\ge 2b$. Chọn các khẳng định <b>sai</b> (chọn nhiều đáp án).',
      ...
      answers: [
        {
          content: '$2a-1 \\ge a+2b-1$',
          is_correct: false,
          explaination:
            'Đúng. Vì $a \\ge 2b \\implies a+a-1 \\ge 2b+a-1 \\implies 2a-1 \\ge a+2b-1$.',
        },
        {
          content: '$4b \\le 2a$',
          is_correct: false,
          explaination: 'Đúng. $a \\ge 2b \\implies 2a \\ge 4b$.',
        },
        {
          content: '$4b+4a \\le 5a+2b$',
          is_correct: false,
          explaination:
            'Đúng. $4b+4a \\le 5a+2b \\iff 2b \\le a$. Điều này đúng vì $a \\ge 2b$.',
        },
        {
          content: '$a \\le 2b$',
          is_correct: true,
          explaination:
            'Sai. Đề bài cho $a \\ge 2b$. Dấu bằng có thể xảy ra, nhưng BĐT này ngược dấu.',
        },
        {
          content: '$a-2b < 0$',
          is_correct: true,
          explaination: 'Sai. Vì $a \\ge 2b \\implies a-2b \\ge 0$.',
        },
      ],
    }, // =================================================================
      ...
      answers: [
        {
          content: '$3x - 6 > 0$',
          is_correct: true,
          explaination: 'Đây là dạng $ax+b>0$ với $a=3, b=-6$.',
        },
        {
          content: '$x^2 - 19 \\le 0$',
          is_correct: false,
          explaination: 'Đây là bất phương trình bậc hai.',
        },
        {
          content: '$0x - 5 < 0$',
          is_correct: false,
          explaination: 'Bất phương trình này có $a=0$.',
        },
        {
          content: '$5x + 4 > 4x - 12$',
          is_correct: false,
          explaination:
            'Đây là BPT có thể đưa về dạng bậc nhất, nhưng BPT bậc nhất 1 ẩn gốc có dạng $ax+b>0$.',
        },
      ],
    },
    {
      ...
      explaination:
        'Thay $x=3$ vào từng bất phương trình, BPT nào cho một khẳng định đúng thì $x=3$ là nghiệm của BPT đó.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Thay $x=3$ ta được $5(3)+4 > 4(3)-12 \\implies 19 > 0$, là một khẳng định <b>đúng</b>.',
        },
        {
          content: '$x - 2 \\le 0$',
          is_correct: false,
          explaination:
            'Thay $x=3$ ta được $3-2 \\le 0 \\implies 1 \\le 0$, là một khẳng định <b>sai</b>.',
        },
        {
          content: '$2x + 15 < 0$',
          is_correct: false,
          explaination:
            'Thay $x=3$ ta được $2(3)+15 < 0 \\implies 21 < 0$, là một khẳng định <b>sai</b>.',
        },
        {
          content: '$x^2 - 3x + 5 \\le 4$',
          is_correct: false,
          explaination:
            'Thay $x=3$ ta được $3^2 - 3(3) + 5 \\le 4 \\implies 5 \\le 4$, là một khẳng định <b>sai</b>.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          content: '$x < 8$',
          is_correct: true,
          explaination: '$4x - 32 < 0 \\implies 4x < 32 \\implies x < 8$.',
        },
        {
          content: '$x > 8$',
          is_correct: false,
          explaination: 'Sai dấu do không đổi chiều BĐT.',
        },
    ...
    }, // --- Medium ---
    {
      ...
      explaination:
        'Khi nhân (hoặc chia) hai vế của BĐT với một số âm, ta phải đổi chiều BĐT.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            '<b>Sai</b>. Khi chia cho -0.3 (số âm) phải đổi chiều BĐT.',
        },
        {
          content: '$x < 40$',
          is_correct: true,
          explaination:
            '$-0.3x > -12 \\implies x < \\frac{-12}{-0.3} \\implies x < 40$.',
        },
    ...
    },
    {
      ...
      explaination:
        'Bỏ dấu ngoặc, chuyển các hạng tử chứa x về một vế, các hằng số về vế còn lại.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        ...
        { content: '$x \\le 9$', is_correct: false },
        {
          ...
          is_correct: true,
          explaination:
            '$3x-6-2x \\le 3x+12 \\implies x-6 \\le 3x+12 \\implies -6-12 \\le 3x-x \\implies -18 \\le 2x \\implies -9 \\le x$.',
        },
        {
          content: '$x \\le -9$',
          is_correct: false,
          explaination: 'Sai dấu khi chuyển vế.',
        },
      ],
    },
    {
      content:
        'Tìm lỗi <b>sai</b> trong lời giải: $3x - 5 - 2x > 25 + 4x \\implies 3x - 2x - 4x > 25 + 5 \\implies -3x > 30 \\implies x > -10$.',
      ...
      answers: [
        ...
        {
          content:
            '<b>Sai</b> ở bước cuối: chia cho số âm mà không đổi chiều BĐT.',
          is_correct: true,
          explaination:
            'Khi nhân hoặc chia hai vế cho số âm (-3), phải đổi chiều bất phương trình. Lời giải <b>đúng</b> là $x < -10$.',
        },
    ...
    {
      content:
        'Một kho chứa 100 tấn xi măng, mỗi ngày xuất đi 20 tấn. Tìm $x$ (số ngày) sao cho khối lượng còn lại trong kho ít nhất là 10 tấn.',
      explaination:
        'Lượng xi măng còn lại sau $x$ ngày là $100 - 20x$. Lập BPT $100 - 20x \ge 10$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Lượng còn lại: $100 - 20x$. Điều kiện: $100 - 20x \\ge 10 \\implies 90 \\ge 20x \\implies 4.5 \\ge x$ hay $x \\le 4.5$.',
        },
        {
          content: '$x \\ge 4.5$',
          is_correct: false,
          explaination: 'Đọc <b>sai</b> điều kiện "ít nhất".',
        },
        { content: '$x \\le 5.5$', is_correct: false },
        {
          ...
          is_correct: false,
          explaination:
            'Đây là trường hợp "bằng", BPT cho phép cả trường hợp "nhỏ hơn".',
        },
      ],
    }, // --- Hard ---
    {
      ...
      answers: [
        {
          content: '200,000,000 đồng',
          is_correct: true,
          explaination:
            '$x(1 + 0.072) \\ge 214400000 \\implies 1.072x \\ge 214400000 \\implies x \\ge 214400000 / 1.072 \\implies x \\ge 200000000$.',
        },
        {
          content: '214,400,000 đồng',
          is_correct: false,
          explaination: 'Đây là số tiền muốn nhận được.',
        },
    ...
    },
    {
      ...
      explaination:
        'Quy đồng mẫu số (nhân hai vế với 2) để khử mẫu, sau đó giải BPT bậc nhất thu được.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Nhân 2 vế: $(8-3x) - 2x < 10 \\implies 8 - 5x < 10 \\implies -5x < 2 \\implies x > -\\frac{2}{5} \\implies x > -0.4$.',
        },
        {
          content: '$x < 0.4$',
          is_correct: false,
          explaination: 'Nhân/chia cho số âm phải đổi chiều BĐT.',
        },
      ],
    }, // =================================================================
...

    {
      ...
      explaination:
        'Một số dương $a$ có đúng hai căn bậc hai là hai số đối nhau: $\\sqrt{a}$ và $-\\sqrt{a}$.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '8',
          is_correct: false,
          explaination: 'Đây là căn bậc hai số học, chưa đủ.',
        },
        {
          content: '-8',
          is_correct: false,
          explaination: 'Đây là một căn bậc hai, chưa đủ.',
        },
        {
          content: '8 và -8',
          is_correct: true,
          explaination: 'Vì $8^2 = 64$ và $(-8)^2 = 64$.',
        },
        {
          content: '32',
          is_correct: false,
          explaination: 'Đây là phép chia 64 cho 2.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          content: '100',
          is_correct: false,
          explaination: '$100^3$ không bằng 1000.',
        },
        {
          content: '10',
          is_correct: true,
          explaination: 'Vì $10^3 = 10 \\times 10 \\times 10 = 1000$.',
        },
        {
          content: '333.33',
          is_correct: false,
          explaination: 'Đây là phép chia cho 3.',
        },
        {
          content: '10 và -10',
          is_correct: false,
          explaination: 'Nhầm lẫn với căn bậc hai.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          content: '144',
          is_correct: false,
          explaination: 'Số 144 có hai căn bậc hai là 12 và -12.',
        },
        {
          content: '0',
          is_correct: false,
          explaination: 'Số 0 có một căn bậc hai là 0.',
        },
        {
          content: '0.25',
          is_correct: false,
          explaination: 'Số 0.25 có hai căn bậc hai là 0.5 và -0.5.',
        },
        {
          content: '-4',
          is_correct: true,
    ...
    }, // --- Medium ---
    {
      ...
      explaination:
        'Đưa 3 vào trong dấu căn bậc hai: $3 = \\sqrt{9}$. Sau đó so sánh $\\sqrt{9}$ và $\\sqrt{10}$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$3 > \\sqrt{10}$',
          is_correct: false,
          explaination: 'Vì $9 < 10$.',
        },
        {
          content: '$3 < \\sqrt{10}$',
          is_correct: true,
          explaination:
            'Ta có $3 = \\sqrt{9}$. Vì $9 < 10$ nên $\\sqrt{9} < \\sqrt{10}$, hay $3 < \\sqrt{10}$.',
        },
    ...
    {
      content:
        'Tính giá trị biểu thức $A = (\\sqrt[3]{2}+1)[(\\sqrt[3]{2})^2 - \\sqrt[3]{2} + 1]$.',
      explaination:
        'Áp dụng hằng đẳng thức tổng hai lập phương: $(a+b)(a^2-ab+b^2) = a^3 + b^3$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        ...
        { content: '2', is_correct: false },
        {
          ...
          is_correct: true,
          explaination:
            'Áp dụng HĐT $a^3+b^3$ với $a = \\sqrt[3]{2}$ và $b = 1$. Ta có $A = (\\sqrt[3]{2})^3 + 1^3 = 2 + 1 = 3$.',
        },
    ...
    },
    {
      ...
      explaination:
        'Đưa -10 vào trong dấu căn bậc ba: $-10 = \\sqrt[3]{(-10)^3} = \\sqrt[3]{-1000}$. So sánh $-1000$ và $-999$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$-10 < \\sqrt[3]{-999}$',
          is_correct: true,
          explaination:
            'Ta có $-10 = \\sqrt[3]{-1000}$. Vì $-1000 < -999$ nên $\\sqrt[3]{-1000} < \\sqrt[3]{-999}$, hay $-10 < \\sqrt[3]{-999}$.',
        },
    ...
    }, // --- Hard ---
    {
      ...
      explaination:
        'Kiểm tra từng phát biểu về tính chất của căn bậc hai và căn bậc ba.',
      level: DifficultyLevel.hard,
      type: QuestionType.multiple_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: 'Mỗi số dương có đúng hai căn bậc hai là hai số đối nhau.',
          is_correct: true,
          explaination: '<b>Đúng</b> theo định nghĩa.',
        },
        {
          content: 'Số âm không có căn bậc ba.',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Số âm có căn bậc ba là một số âm. Ví dụ $\\sqrt[3]{-8} = -2$.',
        },
        {
          content: 'Mỗi số thực a đều có duy nhất một căn bậc ba.',
          is_correct: true,
          explaination: '<b>Đúng</b> theo tính chất của căn bậc ba.',
        },
        {
          content: 'Số 0 có hai căn bậc hai là 0 và -0.',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Số 0 chỉ có một căn bậc hai duy nhất là 0.',
        },
        {
          content: 'Căn bậc ba của một số âm là số âm.',
          is_correct: true,
          explaination: '<b>Đúng</b>. Ví dụ $\\sqrt[3]{-27} = -3$.',
        },
      ],
    },
    {
      content:
        'Một vật rơi tự do từ độ cao 80 m. Quãng đường dịch chuyển h (mét) được cho bởi công thức $h = 5t^2$ với t là thời gian (giây). Hỏi sau bao lâu vật chạm đất?',
      explaination:
        'Thay $h = 80$ vào công thức, ta giải phương trình $80 = 5t^2$ để tìm $t$. Lưu ý $t > 0$.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '16 giây',
          is_correct: false,
          explaination: '$t^2 = 16$, bạn chưa khai căn.',
        },
        {
          content: '4 giây',
          is_correct: true,
          explaination:
            '$80 = 5t^2 \\implies t^2 = 16$. Do $t>0$ nên $t = \\sqrt{16} = 4$ (giây).',
        },
    ...
    {
      content:
        'Thể tích của một khối bê tông hình lập phương là khoảng 220,348 cm³. Độ dài cạnh của khối bê tông đó là bao nhiêu cm (làm tròn đến hàng phần mười)?',
      explaination:
        'Nếu cạnh là $a$ thì thể tích là $V = a^3$. Vậy $a = \\sqrt[3]{V}$. Sử dụng máy tính cầm tay.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            '$a = \\sqrt[3]{220.348}$. Sử dụng máy tính ta được $a \\approx 6.040...$ Làm tròn đến hàng phần mười ta được 6.0 cm.',
        },
        {
          content: '6.04 cm',
          is_correct: false,
          explaination: 'Đây là làm tròn đến hàng phần trăm.',
        },
        {
          content: '73.4 cm',
          is_correct: false,
        ...
        },
        {
          content: '14.8 cm',
          is_correct: false,
          explaination: 'Đây là phép khai căn bậc hai.',
        },
      ],
      ...
      answers: [
        {
          content: '-8',
          is_correct: false,
          explaination: '$\\sqrt{A^2}$ luôn là số không âm.',
        },
        {
          content: '8',
          is_correct: true,
          explaination: '$\\sqrt{(-8)^2} = |-8| = 8$.',
        },
        {
          content: '64',
          is_correct: false,
          explaination: 'Đây là giá trị của $(-8)^2$.',
        },
    ...
    },
    {
      ...
      explaination:
        'Áp dụng quy tắc khai phương một tích: $\\sqrt{A \\cdot B} = \\sqrt{A} \\cdot \\sqrt{B}$ (với $A, B \\ge 0$).',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '3969',
          is_correct: false,
          explaination: 'Đây là kết quả của $81 \\times 49$.',
        },
        {
          content: '63',
          is_correct: true,
        ...
        },
        {
          content: '130',
          is_correct: false,
          explaination: 'Đây là kết quả của $81 + 49$.',
        },
    ...
    },
    {
      ...
      explaination:
        'Áp dụng quy tắc khai phương một thương: $\\sqrt{\\frac{A}{B}} = \\frac{\\sqrt{A}}{\\sqrt{B}}$ (với $A \\ge 0, B > 0$).',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
    ...
    }, // --- Medium ---
    {
      ...
      explaination:
        'Tách 50 thành tích của một số chính phương và một số khác. $50 = 25 \\cdot 2 = 5^2 \\cdot 2$. Áp dụng $\\sqrt{A^2 B} = |A|\\sqrt{B}$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
    ...
    },
    {
      ...
      explaination:
        'Áp dụng quy tắc: Với $a < 0$ và $b \\ge 0$, ta có $a\\sqrt{b} = -\\sqrt{a^2 b}$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$\\sqrt{50}$',
          is_correct: false,
          explaination: 'Đây là kết quả của $5\\sqrt{2}$.',
        },
        {
          content: '$\\sqrt{-50}$',
          is_correct: false,
          explaination: 'Biểu thức dưới dấu căn không thể âm.',
        },
        {
          content: '$-\\sqrt{50}$',
          is_correct: true,
          explaination:
            'Vì $-5 < 0$, nên $-5\\sqrt{2} = -\\sqrt{(-5)^2 \\cdot 2} = -\\sqrt{25 \\cdot 2} = -\\sqrt{50}$.',
        },
    ...
    },
    {
      ...
      explaination:
        'Đưa thừa số $\\sqrt{20}$ ra ngoài dấu căn, sau đó thực hiện phép trừ các căn thức đồng dạng.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$\\sqrt{15}$',
          is_correct: false,
          explaination: 'Không thể trừ trực tiếp hai số dưới dấu căn.',
        },
        {
          content: '$\\sqrt{5}$',
          is_correct: true,
          explaination:
            '$\\sqrt{20} - \\sqrt{5} = \\sqrt{4 \\cdot 5} - \\sqrt{5} = 2\\sqrt{5} - \\sqrt{5} = (2-1)\\sqrt{5} = \\sqrt{5}$.',
        },
        { content: '$2\\sqrt{5}$', is_correct: false },
    ...
    }, // --- Hard ---
    {
      ...
      explaination:
        'Đưa thừa số ra ngoài dấu căn của cả ba hạng tử, sau đó cộng/trừ các căn thức đồng dạng.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            '$A = \\sqrt{4 \\cdot 3} - \\sqrt{9 \\cdot 3} + \\sqrt{25 \\cdot 3} = 2\\sqrt{3} - 3\\sqrt{3} + 5\\sqrt{3} = (2 - 3 + 5)\\sqrt{3} = 4\\sqrt{3}$.',
        },
        {
          content: '$\\sqrt{60}$',
          is_correct: false,
          explaination: 'Không thể cộng/trừ các số dưới dấu căn.',
        },
        {
          content: '$10\\sqrt{3}$',
          is_correct: false,
          explaination: 'Sai dấu khi tính toán.',
        },
        {
          content: '$2\\sqrt{3}$',
          is_correct: false,
    ...
    },
    {
      ...
      explaination:
        'Đưa thừa số $\\sqrt{12}$ ra ngoài dấu căn để xuất hiện hằng đẳng thức $(a+b)(a-b) = a^2 - b^2$.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        ...
        { content: '$2\\sqrt{33}$', is_correct: false },
        {
          ...
          is_correct: true,
          explaination:
            'Ta có $\\sqrt{12} = \\sqrt{4 \\cdot 3} = 2\\sqrt{3}$. Biểu thức trở thành $(2\\sqrt{3} + \\sqrt{11})(2\\sqrt{3} - \\sqrt{11}) = (2\\sqrt{3})^2 - (\\sqrt{11})^2 = (4 \\cdot 3) - 11 = 12 - 11 = 1$.',
        },
    ...
    {
      content:
        'Một bếp điện có điện trở $R = 80 \\Omega$. Tính cường độ dòng điện $I$ (Ampe) chạy qua, biết nhiệt lượng $Q$ toả ra trong 1 giây ($t=1$) là 500 J. Dùng công thức $Q = I^2Rt$.',
      explaination:
        'Thay các giá trị $Q=500, R=80, t=1$ vào công thức và giải $I$.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            '$500 = I^2 \\cdot 80 \\cdot 1 \\implies I^2 = \\frac{500}{80} = \\frac{50}{8} = 6.25$. Vì $I > 0$, ta có $I = \\sqrt{6.25} = 2.5$ A.',
        },
        {
          content: '6.25 A',
          is_correct: false,
          explaination: 'Đây là giá trị của $I^2$.',
        },
        {
          content: '3.125 A',
          is_correct: false,
          explaination: 'Đây là kết quả $Q / (R \\cdot t \\cdot 2)$.',
        },
        {
          content: '40000 A',
          is_correct: false,
          explaination: 'Đây là $Q \\times R$.',
        },
      ],
    ...
    {
      content:
        'Biểu thức $\\sqrt{A}$ được gọi là căn thức bậc hai của A khi nào?',
      ...
      answers: [
        ...
        {
          content: 'A là một biểu thức đại số',
          is_correct: true,
          explaination: 'Theo định nghĩa, A là một biểu thức đại số.',
        },
        {
          content: 'A là một số thực không âm',
          is_correct: false,
          explaination: 'Đây là điều kiện xác định, không phải định nghĩa.',
        },
    ...
    },
    {
      ...
      answers: [
        { content: '$x > 3$', is_correct: false },
        {
          ...
          is_correct: true,
          explaination:
            'Biểu thức xác định khi $x-3 \\ge 0 \\implies x \\ge 3$.',
        },
        { content: '$x < 3$', is_correct: false },
    ...
    {
      content:
        'Tìm điều kiện xác định cho căn thức bậc ba $\\sqrt[3]{\\frac{1}{x-9}}$.',
      explaination:
        'Căn thức bậc ba $\\sqrt[3]{A}$ xác định khi biểu thức A xác định. Biểu thức $\\frac{1}{x-9}$ xác định khi mẫu khác 0.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Căn bậc ba không yêu cầu biểu thức bên trong phải không âm.',
        },
        { content: '$x \\ge 9$', is_correct: false },
        {
          content: '$x \\ne 9$',
          is_correct: true,
          explaination:
            'Căn thức bậc ba $\\sqrt[3]{A}$ xác định khi A xác định. $A = \\frac{1}{x-9}$ xác định khi $x-9 \\ne 0 \\implies x \\ne 9$.',
        },
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            '$\\sqrt{(\\sqrt{10})^2 - 9} = \\sqrt{10 - 9} = \\sqrt{1} = 1$.',
        },
        {
          content: '$\\sqrt{1}$',
          is_correct: false,
          explaination: 'Kết quả này có thể rút gọn thêm.',
        },
        { content: '19', is_correct: false },
        {
          content: 'Không xác định',
          is_correct: false,
          explaination: 'Biểu thức xác định vì $10 > 9$.',
        },
      ],
    },
    {
      ...
      explaination:
        'Biểu thức $\\sqrt{A}$ xác định khi $A \\ge 0$. Xét dấu của biểu thức $x^2 + 1$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        ...
        {
          content: 'Với mọi $x \\in \\mathbb{R}$',
          is_correct: true,
          explaination:
            'Ta có $x^2 \\ge 0$ với mọi $x$. Do đó $x^2 + 1 \\ge 1 > 0$ với mọi $x$. Vậy biểu thức luôn xác định.',
        },
      ],
    },
    {
      ...
      answers: [
        { content: '3', is_correct: false },
        {
          ...
          is_correct: true,
          explaination:
            '$\\sqrt[3]{2(-10) - 7} = \\sqrt[3]{-20 - 7} = \\sqrt[3]{-27} = -3$.',
        },
        {
          content: 'Không xác định',
          is_correct: false,
          explaination: 'Căn bậc ba xác định với cả số âm.',
        },
    ...
    {
      content:
        'Cho công thức $v = \\sqrt{rg\\mu}$. Tính tốc độ tối đa $v$ (m/s) khi $g=9.8$, $r=400$m và $\\mu=0.12$ (làm tròn đến hàng phần mười).',
      explaination:
        'Thay các giá trị $r=400, g=9.8, \\mu=0.12$ vào công thức và dùng máy tính để tính toán.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            '$v = \\sqrt{400 \\times 9.8 \\times 0.12} = \\sqrt{470.4} \\approx 21.688...$ Làm tròn đến hàng phần mười ta được 21.7 m/s.',
        },
        {
          content: '470.4 m/s',
          is_correct: false,
          explaination: 'Bạn chưa khai căn.',
        },
        {
          content: '21.69 m/s',
          is_correct: false,
          explaination: '<b>Sai</b> yêu cầu làm tròn (đây là hàng phần trăm).',
        },
    ...
    {
      content:
        'Một con hươu cao cổ nặng 180 kg. Dùng công thức $h = 0.4 \\cdot \\sqrt[3]{x}$ (với $x$ là cân nặng) để tính chiều cao $h$ (mét) của nó (làm tròn đến hàng phần trăm).',
      explaination:
        'Thay $x = 180$ vào công thức $h = 0.4 \\cdot \\sqrt[3]{180}$ và dùng máy tính để tính.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            '$h = 0.4 \\cdot \\sqrt[3]{180} \\approx 0.4 \\cdot 5.646... \\approx 2.258...$ Làm tròn đến hàng phần trăm ta được 2.26 m.',
        },
        {
          content: '5.65 m',
          is_correct: false,
          explaination: 'Đây là giá trị của $\\sqrt[3]{180}$, chưa nhân 0.4.',
        },
        {
          content: '2.3 m',
          is_correct: false,
          explaination: 'Đây là làm tròn đến hàng phần mười.',
        },
        {
          content: '72 m',
          is_correct: false,
          explaination: 'Đây là $180 \\times 0.4$.',
        },
      ],
    },
    {
      ...
      explaination:
        'Biểu thức $\\sqrt{A}$ xác định khi $A \\ge 0$. Do đó, $\\frac{-5}{x-2} \\ge 0$. Vì tử số -5 là số âm, nên mẫu số $x-2$ cũng phải là số âm (và khác 0) để thương là số dương.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Nếu $x > 2$ thì $x-2 > 0$. (Số âm) / (Số dương) = (Số âm), vi phạm ĐKXĐ.',
        },
        {
          content: '$x \\ge 2$',
          is_correct: false,
          explaination: 'Vi phạm ĐKXĐ và $x=2$ làm mẫu bằng 0.',
        },
        {
          content: '$x < 2$',
          is_correct: true,
          explaination:
            'Ta cần $\\frac{-5}{x-2} \\ge 0$. Vì $-5 < 0$, ta phải có $x-2 < 0$ (mẫu không được bằng 0). Do đó, $x < 2$.',
        },
        {
          content: '$x \\ne 2$',
          is_correct: false,
          explaination: 'Chưa đủ, $x=3$ làm biểu thức âm.',
        },
      ],
    ...
    // =================================================================
    {
      ...
      explaination:
        'Áp dụng hằng đẳng thức $\\sqrt{A^2} = |A|$. Vì $x \\ge 2$ nên $x-2 \\ge 0$, do đó $|x-2| = x-2$.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$x-2$',
          is_correct: true,
          explaination: '$\\sqrt{(x-2)^2} = |x-2| = x-2$ (vì $x \\ge 2$).',
        },
        {
          content: '$2-x$',
          is_correct: false,
          explaination: 'Đây là kết quả khi $x < 2$.',
        },
    ...
    },
    {
      ...
      explaination:
        'Áp dụng quy tắc khai phương một tích $\\sqrt{A \\cdot B} = \\sqrt{A} \\cdot \\sqrt{B}$ và hằng đẳng thức $\\sqrt{A^2} = |A|$.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        { content: '$4a$', is_correct: false },
        {
          ...
          is_correct: true,
          explaination:
            '$\\sqrt{4a^2} = \\sqrt{4} \\cdot \\sqrt{a^2} = 2|a| = 2a$ (vì $a \\ge 0$).',
        },
        {
          content: '$-2a$',
          is_correct: false,
          explaination: 'Đây là kết quả khi $a < 0$.',
        },
        {
          content: '$2|a|$',
          is_correct: false,
          explaination: 'Kết quả này có thể rút gọn thêm vì đã cho $a \\ge 0$.',
        },
      ],
    },
    {
      ...
      explaination:
        'Nhân cả tử và mẫu với $\\sqrt{3}$. Ta có $\\frac{A}{\\sqrt{B}} = \\frac{A\\sqrt{B}}{B}$.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
    ...
    }, // --- Medium ---
    {
      ...
      explaination:
        'Đưa biểu thức dưới dấu căn về dạng bình phương của một tổng: $(x+3)^2$. Áp dụng $\\sqrt{A^2} = |A|$ và xét dấu của $x+3$ khi $x < -3$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            '<b>Sai</b>. Vì $x < -3$ nên $x+3 < 0$, do đó $|x+3| = -(x+3)$.',
        },
        {
          content: '$-(x+3)$',
          is_correct: true,
          explaination:
            '$\\sqrt{(x+3)^2} = |x+3|$. Vì $x < -3$ nên $x+3$ là số âm, do đó $|x+3| = -(x+3) = -x-3$.',
        },
        { content: '$x-3$', is_correct: false },
    ...
    },
    {
      ...
      explaination:
        'Nhân cả tử và mẫu với biểu thức liên hợp của $2+\\sqrt{3}$ là $2-\\sqrt{3}$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            '$\\frac{5(2-\\sqrt{3})}{(2+\\sqrt{3})(2-\\sqrt{3})} = \\frac{5(2-\\sqrt{3})}{2^2 - (\\sqrt{3})^2} = \\frac{5(2-\\sqrt{3})}{4-3} = 5(2-\\sqrt{3})$.',
        },
        {
          content: '$5(2+\\sqrt{3})$',
          is_correct: false,
          explaination: 'Nhân sai biểu thức liên hợp.',
        },
        {
          content: '$\\frac{5(2-\\sqrt{3})}{7}$',
          is_correct: false,
          explaination: 'Sai hằng đẳng thức $a^2-b^2$.',
        },
        {
          content: '$10- \\sqrt{3}$',
          is_correct: false,
          explaination: 'Sai phép nhân.',
        },
      ],
    },
    {
      content:
        'Rút gọn biểu thức $\\sqrt{2a} \\cdot \\sqrt{8a}$ với $a \\ge 0$.',
      explaination:
        'Áp dụng quy tắc nhân hai căn thức bậc hai: $\\sqrt{A} \\cdot \\sqrt{B} = \\sqrt{AB}$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            '$\\sqrt{2a \\cdot 8a} = \\sqrt{16a^2} = \\sqrt{16} \\cdot \\sqrt{a^2} = 4|a| = 4a$ (vì $a \\ge 0$).',
        },
        { content: '$\\sqrt{16a}$', is_correct: false },
        {
          content: '$4|a|$',
          is_correct: false,
          explaination: 'Kết quả này có thể rút gọn thêm vì $a \\ge 0$.',
        },
    ...
    },
    {
      ...
      explaination:
        'Áp dụng quy tắc khai phương một thương $\\sqrt{A/B} = \\sqrt{A}/\\sqrt{B}$ và hằng đẳng thức $\\sqrt{A^2} = |A|$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$\\frac{2a}{5}$',
          is_correct: false,
          explaination: '<b>Sai</b>. Vì $a < 0$ nên $|a| = -a$.',
        },
        { content: '$\\frac{4a}{5}$', is_correct: false },
        {
          ...
          is_correct: true,
          explaination:
            '$\\sqrt{\\frac{4a^2}{25}} = \\frac{\\sqrt{4a^2}}{\\sqrt{25}} = \\frac{\\sqrt{4} \\cdot \\sqrt{a^2}}{5} = \\frac{2|a|}{5}$. Vì $a < 0$ nên $|a| = -a$. Kết quả là $\\frac{-2a}{5}$.',
        },
    ...
    {
      content:
        'Trục căn thức ở mẫu của $\\frac{1}{\\sqrt{x+1} - \\sqrt{x}}$ (với $x \\ge 0$).',
      explaination:
        'Nhân cả tử và mẫu với biểu thức liên hợp là $\\sqrt{x+1} + \\sqrt{x}$.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$\\sqrt{x+1} + \\sqrt{x}$',
          is_correct: true,
          explaination:
            '$\\frac{1 \\cdot (\\sqrt{x+1} + \\sqrt{x})}{(\\sqrt{x+1} - \\sqrt{x})(\\sqrt{x+1} + \\sqrt{x})} = \\frac{\\sqrt{x+1} + \\sqrt{x}}{(\\sqrt{x+1})^2 - (\\sqrt{x})^2} = \\frac{\\sqrt{x+1} + \\sqrt{x}}{(x+1) - x} = \\frac{\\sqrt{x+1} + \\sqrt{x}}{1}$.',
        },
        { content: '$\\sqrt{x+1} - \\sqrt{x}$', is_correct: false },
        {
          content: '1',
          is_correct: false,
          explaination: 'Đây là kết quả của mẫu số.',
        },
        { content: '-1', is_correct: false },
      ],
    },
    {
      content:
        'Rút gọn biểu thức $P = \\frac{\\sqrt{a}}{\\sqrt{a}-\\sqrt{b}} - \\frac{\\sqrt{b}}{\\sqrt{a}+\\sqrt{b}} - \\frac{2b}{a-b}$ (với $a \\ge 0, b \\ge 0, a \\ne b$).',
      explaination:
        'Quy đồng mẫu số. Mẫu số chung là $a-b = (\\sqrt{a}-\\sqrt{b})(\\sqrt{a}+\\sqrt{b})$.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Quy đồng ta được: $P = \\frac{\\sqrt{a}(\\sqrt{a}+\\sqrt{b}) - \\sqrt{b}(\\sqrt{a}-\\sqrt{b}) - 2b}{a-b} = \\frac{a+\\sqrt{ab} - \\sqrt{ab}+b - 2b}{a-b} = \\frac{a-b}{a-b} = 1$.',
        },
        {
          content: '$\\frac{a+b}{a-b}$',
          is_correct: false,
          explaination:
            'Đây là kết quả của 2 hạng tử đầu tiên, chưa trừ $\\frac{2b}{a-b}$.',
        },
    ...
    {
      content:
        'Bất đẳng thức Cauchy (AM-GM) cho hai số không âm $a$ và $b$ là gì?',
      explaination:
        'Đây là bất đẳng thức giữa trung bình cộng và trung bình nhân.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đây là một dạng tương đương, nhưng dạng chuẩn là so sánh trung bình cộng và trung bình nhân.',
        },
        {
          content: '$\\frac{a+b}{2} \\ge \\sqrt{ab}$',
          is_correct: true,
          explaination:
            'Bất đẳng thức Cauchy (AM-GM) cho hai số $a, b \\ge 0$ là $\\frac{a+b}{2} \\ge \\sqrt{ab}$.',
        },
        {
          content: '$\\frac{a+b}{2} \\le \\sqrt{ab}$',
          is_correct: false,
          explaination: 'Ngược dấu.',
        },
        {
          content: '$(\\sqrt{a}-\\sqrt{b})^2 \\ge 0$',
          is_correct: false,
          explaination: 'Đây là BĐT dùng để chứng minh BĐT Cauchy.',
        },
      ],
    ...
    {
      content:
        'Trong một tam giác vuông, tỉ số giữa cạnh đối và cạnh huyền của một góc nhọn $\\alpha$ được gọi là gì?',
    ...
    {
      content:
        'Tỉ số $tan \\alpha$ của góc nhọn $\\alpha$ trong tam giác vuông bằng:',
      ...
      answers: [
        {
          content: '$\\frac{\\text{Cạnh kề}}{\\text{Cạnh huyền}}$',
          is_correct: false,
          explaination: 'Đây là $cos \\alpha$.',
        },
        {
          content: '$\\frac{\\text{Cạnh đối}}{\\text{Cạnh huyền}}$',
          is_correct: false,
          explaination: 'Đây là $sin \\alpha$.',
        },
        {
          content: '$\\frac{\\text{Cạnh kề}}{\\text{Cạnh đối}}$',
          is_correct: false,
          explaination: 'Đây là $cot \\alpha$.',
        },
        {
          content: '$\\frac{\\text{Cạnh đối}}{\\text{Cạnh kề}}$',
          is_correct: true,
          explaination:
            '$tan \\alpha = \\frac{\\text{Cạnh đối}}{\\text{Cạnh kề}}$.',
        },
    ...
    {
      content:
        'Nếu $\\alpha$ và $\\beta$ là hai góc phụ nhau ( $\\alpha + \\beta = 90^{\\circ}$ ) thì khẳng định nào sau đây là <b>ĐÚNG</b>?',
      explaination:
      ...
      answers: [
        { content: '$sin \\alpha = sin \\beta$', is_correct: false },
        {
          ...
          is_correct: true,
          explaination: 'Với hai góc phụ nhau, sin góc này bằng côsin góc kia.',
        },
    ...
    {
      content:
        'Cho tam giác ABC vuông tại A, có $AC = 4$ cm, $BC = 5$ cm. Tính $sin B$.',
      explaination:
      ...
      answers: [
        {
          content: '$\\frac{3}{5} = 0.6$',
          is_correct: false,
          explaination: 'Đây là $cos B$.',
        },
        {
          content: '$\\frac{4}{5} = 0.8$',
          is_correct: true,
          explaination: '$sin B = \\frac{AC}{BC} = \\frac{4}{5} = 0.8$.',
        },
        {
          content: '$\\frac{4}{3}$',
          is_correct: false,
          explaination: 'Đây là $tan B$.',
        },
      ...
      answers: [
        {
          content: '$\\frac{1}{2}$',
          is_correct: false,
          explaination: 'Đây là $sin 30^{\\circ}$ hoặc $cos 60^{\\circ}$.',
        },
        {
          content: '$\\frac{\\sqrt{3}}{2}$',
          is_correct: true,
          explaination:
            'Theo bảng giá trị đặc biệt, $cos 30^{\\circ} = \\frac{\\sqrt{3}}{2}$.',
        },
        {
          content: '$\\frac{\\sqrt{2}}{2}$',
          is_correct: false,
          explaination: 'Đây là $cos 45^{\\circ}$.',
        },
        {
          content: '$\\sqrt{3}$',
          is_correct: false,
          explaination: 'Đây là $cot 30^{\\circ}$.',
        },
      ],
    },
    {
      content:
        'Cho tam giác MNP vuông tại M, $MN = 3$ cm, $MP = 4$ cm. Chọn các khẳng định <b>ĐÚNG</b> (chọn nhiều đáp án).',
      explaination:
        'Đầu tiên, dùng định lý Pytago để tìm cạnh huyền $NP = \\sqrt{MN^2 + MP^2} = \\sqrt{3^2 + 4^2} = 5$ cm. Sau đó tính các tỉ số lượng giác của góc P.',
      level: DifficultyLevel.medium,
      type: QuestionType.multiple_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$sin P = \\frac{3}{5}$',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. $sin P = \\frac{\\text{Đối}}{\\text{Huyền}} = \\frac{MN}{NP} = \\frac{3}{5}$.',
        },
        {
          content: '$cos P = \\frac{4}{5}$',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. $cos P = \\frac{\\text{Kề}}{\\text{Huyền}} = \\frac{MP}{NP} = \\frac{4}{5}$.',
        },
        {
          content: '$tan P = \\frac{3}{4}$',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. $tan P = \\frac{\\text{Đối}}{\\text{Kề}} = \\frac{MN}{MP} = \\frac{3}{4}$.',
        },
        {
          content: '$cot P = \\frac{5}{3}$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. $cot P = \\frac{\\text{Kề}}{\\text{Đối}} = \\frac{MP}{MN} = \\frac{4}{3}$.',
        },
      ],
    }, // --- Hard ---
    {
      content:
        'Tính giá trị biểu thức $A = sin 25^{\\circ} + cos 25^{\\circ} - sin 65^{\\circ} - cos 65^{\\circ}$.',
      explaination:
        'Sử dụng tỉ số lượng giác của hai góc phụ nhau ($25^{\\circ}$ và $65^{\\circ}$). $sin 65^{\\circ} = cos(90^{\\circ}-65^{\\circ}) = cos 25^{\\circ}$ và $cos 65^{\\circ} = sin(90^{\\circ}-65^{\\circ}) = sin 25^{\\circ}$.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        { content: '1', is_correct: false },
        {
          ...
          is_correct: true,
          explaination:
            '$A = sin 25^{\\circ} + cos 25^{\\circ} - (sin 65^{\\circ}) - (cos 65^{\\circ}) = sin 25^{\\circ} + cos 25^{\\circ} - (cos 25^{\\circ}) - (sin 25^{\\circ}) = (sin 25^{\\circ} - sin 25^{\\circ}) + (cos 25^{\\circ} - cos 25^{\\circ}) = 0$.',
        },
        { content: '2', is_correct: false },
        { content: '$-1$', is_correct: false },
      ],
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination: 'Đây là hệ thức lượng giác cơ bản, luôn <b>đúng</b>.',
        },
        {
          content: '$tan \\alpha = \\frac{sin \\alpha}{cos \\alpha}$',
          is_correct: false,
          explaination: 'Đây là hệ thức lượng giác cơ bản, luôn <b>đúng</b>.',
        },
        {
          content: '$tan \\alpha \\cdot cot \\alpha = 1$',
          is_correct: false,
          explaination: 'Đây là hệ thức lượng giác cơ bản, luôn <b>đúng</b>.',
        },
        {
          ...
          is_correct: true,
          explaination:
            'Đây là khẳng định <b>sai</b>. Chỉ có $sin^2 \\alpha + cos^2 \\alpha = 1$.',
        },
      ],
    },
    {
      content:
        'Một cái thang dài 12m đặt dựa vào tường. Chân thang cách tường 7m. Tính góc $\\alpha$ tạo bởi thang và <b>tường</b> (làm tròn đến độ).',
      explaination:
        'Vẽ tam giác vuông, 12m là cạnh huyền, 7m là cạnh đối của góc $\\alpha$ (góc giữa thang và tường).',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Gọi tam giác vuông là ABC (vuông tại A), AB là tường, AC là mặt đất. Thang là BC=12m. Chân thang cách tường AC=7m. Góc $\\alpha$ giữa thang (BC) và tường (AB) là góc $\\hat{B}$. Ta có $sin B = \\frac{AC}{BC} = \\frac{7}{12} \\approx 0.5833$. Dùng máy tính: $sin^{-1}(7/12) \\approx 35.68...^{\\circ} \\approx 36^{\\circ}$.',
        },
        {
          content: '$54^{\\circ}$',
          is_correct: false,
          explaination: 'Đây là góc tạo bởi thang và mặt đất ($cos C = 7/12$).',
        },
    ...
    {
      content:
        'Cho tam giác ABC vuông tại A. Chọn các hệ thức <b>ĐÚNG</b> (chọn nhiều đáp án).',
      explaination:
        'Kiểm tra các hệ thức cơ bản dựa trên định nghĩa tỉ số lượng giác.',
      level: DifficultyLevel.hard,
      type: QuestionType.multiple_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$tan B = \\frac{AC}{AB}$',
          is_correct: true,
          explaination: '<b>Đúng</b>. $tan = \\frac{\\text{Đối}}{\\text{Kề}}$.',
        },
        {
          content: '$sin B = cos C$',
          is_correct: true,
          explaination: '<b>Đúng</b>. Vì B và C là hai góc phụ nhau.',
        },
        {
          content: '$cos B = \\frac{AC}{BC}$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Đây là $sin B$. $cos B$ phải là $\\frac{AB}{BC}$.',
        },
        {
          content: '$cot C = \\frac{AC}{AB}$',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. $cot C = \\frac{\\text{Kề (với góc C)}}{\\text{Đối (với góc C)}} = \\frac{AC}{AB}$.',
        },
      ],
    ...
    {
      content:
        'Cho tam giác ABC vuông tại A, hệ thức nào sau đây là <b>ĐÚNG</b>?',
      explaination:
      ...
      answers: [
        {
          content: '$AB = BC \\cdot sin C$',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. Cạnh góc vuông (AB) bằng cạnh huyền (BC) nhân sin góc đối (sin C).',
        },
        {
          content: '$AB = BC \\cdot sin B$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Phải là $AB = BC \\cdot cos B$ (nhân với cosin góc kề).',
        },
        {
          content: '$AC = BC \\cdot cos C$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Phải là $AC = BC \\cdot sin B$ (nhân với sin góc đối).',
        },
        {
          content: '$AB = AC \\cdot sin C$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Đây là hệ thức giữa hai cạnh góc vuông, không phải với cạnh huyền.',
        },
      ],
    },
    {
      content:
        'Trong tam giác ABC vuông tại A, hệ thức nào sau đây là <b>ĐÚNG</b>?',
      explaination:
      ...
      answers: [
        {
          content: '$AC = AB \\cdot tan C$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Phải là $AC = AB \\cdot cot B$ (nhân với cotang góc kề).',
        },
        {
          content: '$AC = AB \\cdot cot C$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Phải là $AC = AB \\cdot tan B$ (nhân với tang góc đối).',
        },
        {
          content: '$AB = AC \\cdot tan B$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Phải là $AB = AC \\cdot cot B$ (nhân với cotang góc kề).',
        },
        {
          content: '$AB = AC \\cdot tan C$',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. Cạnh góc vuông (AB) bằng cạnh góc vuông kia (AC) nhân tang góc đối (tan C).',
        },
      ],
    },
    {
      ...
      answers: [
        ...
        {
          content:
            'Tìm độ dài các cạnh và số đo các góc còn lại của tam giác vuông đó',
          is_correct: true,
          explaination: '<b>Đúng</b>, đây là định nghĩa.',
        },
        {
          content: 'Chứng minh tam giác đó vuông.',
          is_correct: false,
          explaination: 'Tam giác đã cho là vuông rồi.',
        },
      ],
    }, // --- Medium ---
    {
      content:
        'Cho tam giác ABC vuông tại A, $BC = 20$ cm và $\\hat{B} = 22^{\\circ}$. Tính độ dài cạnh $AB$ (làm tròn đến hàng phần mười).',
      explaination:
        'Sử dụng hệ thức: Cạnh góc vuông (AB) = Cạnh huyền (BC) $\\times$ cosin góc kề (cos B). $AB = 20 \\cdot cos(22^{\\circ})$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đây là $20 \\cdot sin(22^{\\circ})$, là độ dài cạnh AC.',
        },
        {
          content: '18.5 cm',
          is_correct: true,
          explaination:
            '$AB = 20 \\cdot cos(22^{\\circ}) \\approx 20 \\cdot 0.927 \\approx 18.54$ cm. Làm tròn là 18.5 cm.',
        },
        {
          content: '8.1 cm',
          is_correct: false,
          explaination: 'Đây là $20 \\cdot tan(22^{\\circ})$.',
        },
        {
          content: '19.4 cm',
          is_correct: false,
          explaination: 'Đây là $20 \\cdot sin(68^{\\circ})$.',
        },
      ],
    },
    {
      content:
        'Một cột cờ cao $h$ (m). Tại một thời điểm, bóng của cột cờ trên mặt đất dài 12m và góc tạo bởi tia nắng mặt trời với mặt đất là $40^{\\circ}$. Tính $h$ (làm tròn đến hàng phần mười).',
      explaination:
        'Chiều cao cột cờ là cạnh đối, bóng là cạnh kề của góc $40^{\\circ}$. Dùng $h = 12 \\cdot tan(40^{\\circ})$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '14.3 m',
          is_correct: false,
          explaination: 'Đây là $12 / cos(40^{\\circ})$.',
        },
        {
          content: '9.2 m',
          is_correct: false,
          explaination: 'Đây là $12 \\cdot sin(40^{\\circ})$.',
        },
        {
          content: '10.1 m',
          is_correct: true,
          explaination:
            '$h = 12 \\cdot tan(40^{\\circ}) \\approx 12 \\cdot 0.839 \\approx 10.068$ m. Làm tròn là 10.1 m.',
        },
        {
          content: '7.7 m',
          is_correct: false,
          explaination: 'Đây là $12 \\cdot cos(40^{\\circ})$.',
        },
      ],
    },
    {
      content:
        'Giải tam giác ABC vuông tại A, biết $AB = 4$ cm và $AC = 6$ cm. (Làm tròn góc đến độ).',
      explaination:
        'Dùng Pytago tìm BC. Dùng $tan B = \\frac{AC}{AB}$ để tìm góc B. Dùng $\\hat{C} = 90^{\\circ} - \\hat{B}$ để tìm góc C.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content:
            '$BC \\approx 7.2$ cm, $\\hat{B} \\approx 34^{\\circ}$, $\\hat{C} \\approx 56^{\\circ}$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. $tan B = \\frac{AC}{AB} = \\frac{6}{4} = 1.5$, do đó $\\hat{B}$ phải lớn hơn $45^{\\circ}$.',
        },
        {
          content:
            '$BC \\approx 7.2$ cm, $\\hat{B} \\approx 56^{\\circ}$, $\\hat{C} \\approx 34^{\\circ}$',
          is_correct: true,
          explaination:
            '$BC = \\sqrt{4^2 + 6^2} = \\sqrt{16+36} = \\sqrt{52} \\approx 7.2$ cm. $tan B = \\frac{AC}{AB} = \\frac{6}{4} = 1.5 \\implies \\hat{B} \\approx 56^{\\circ}$. $\\hat{C} = 90^{\\circ} - 56^{\\circ} = 34^{\\circ}$.',
        },
        {
          content:
            '$BC = 10$ cm, $\\hat{B} \\approx 53^{\\circ}$, $\\hat{C} \\approx 37^{\\circ}$',
          is_correct: false,
          explaination: 'Nhầm lẫn với tam giác 3-4-5.',
        },
        {
          content:
            '$BC \\approx 7.2$ cm, $\\hat{B} \\approx 48^{\\circ}$, $\\hat{C} \\approx 42^{\\circ}$',
          is_correct: false,
        },
      ],
    }, // --- Hard ---
    {
      content:
        'Cho tam giác nhọn ABC, đường cao AH. Khẳng định nào sau đây là <b>ĐÚNG</b>?',
      explaination:
        'Xét tam giác vuông ABH và tam giác vuông ACH. Viết $AH$ theo hai cách.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$AH = AC \\cdot cos C$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. $AH$ là cạnh đối của góc C, nên $AH = AC \\cdot sin C$.',
        },
        {
          content: '$AH = AB \\cdot sin B$',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. Trong tam giác vuông ABH, $AH$ là cạnh đối của góc B, nên $AH = AB \\cdot sin B$.',
        },
        {
          content: '$AH = BC \\cdot sin B$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. BC không phải là cạnh huyền của tam giác ABH.',
        },
        {
          content: '$AH = AB \\cdot cos B$',
          is_correct: false,
          explaination: '<b>Sai</b>. Đây là công thức tính $BH$.',
        },
      ],
    },
    {
      content:
        'Từ vị trí A cao 68m, bác Duy nhìn thấy chân tháp (B) và đỉnh tháp (C) với các góc hạ và góc nâng lần lượt là $28^{\\circ}$ và $43^{\\circ}$. Tính chiều cao BC của tháp (làm tròn hàng phần mười).',
      explaination:
        'Gọi H là điểm trên tháp ngang với A. Tính khoảng cách ngang $AH = BD$ qua $\\Delta ABH$. Sau đó dùng $AH$ để tính $CH$ trong $\\Delta ACH$. Chiều cao tháp $BC = CH + HB$ (với $HB = AD = 68$m).',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            '<b>Sai</b>. $AH = AD / tan(28^{\\circ}) = 68 / tan(28^{\\circ}) \\approx 127.9$m. $CH = AH \\cdot tan(43^{\\circ}) \\approx 127.9 \\cdot 0.9325 \\approx 119.3$m. $BC = CH + HB = 119.3 + 68 = 187.3$m.',
        },
        {
          content: '$119.3$ m',
          is_correct: false,
          explaination: 'Đây chỉ là độ cao $CH$ từ điểm A lên đỉnh C.',
        },
        {
          content: '$187.3$ m',
          is_correct: true,
          explaination:
            'Khoảng cách ngang $AH = 68 / tan(28^{\\circ}) \\approx 127.9$ m. Chiều cao $CH = AH \\cdot tan(43^{\\circ}) \\approx 127.9 \\cdot 0.9325 \\approx 119.3$ m. Tổng chiều cao $BC = CH + AD = 119.3 + 68 = 187.3$ m.',
        },
        {
          content: '$127.9$ m',
          is_correct: false,
          explaination: 'Đây là khoảng cách ngang $AH$ (hay BD).',
        },
      ],
    },
    {
      content:
        'Chọn các hệ thức <b>ĐÚNG</b> để giải tam giác ABC vuông tại A, biết $AC = 7$ cm và $\\hat{B} = 55^{\\circ}$. (Chọn nhiều đáp án)',
      explaination:
        'Áp dụng các hệ thức lượng trong tam giác vuông. Cạnh AC là cạnh đối của góc B.',
      level: DifficultyLevel.hard,
      type: QuestionType.multiple_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$\\hat{C} = 35^{\\circ}$',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. $\\hat{C} = 90^{\\circ} - \\hat{B} = 90^{\\circ} - 55^{\\circ} = 35^{\\circ}$.',
        },
        {
          content: '$AB = 7 \\cdot tan(55^{\\circ})$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Phải là $AB = AC \\cdot cot(B) = 7 \\cdot cot(55^{\\circ})$.',
        },
        {
          content: '$AB = 7 \\cdot cot(55^{\\circ})$',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. Cạnh góc vuông (AB) = Cạnh góc vuông kia (AC) $\\times$ cotang góc kề (cot B).',
        },
        {
          content: '$BC = \\frac{7}{cos(55^{\\circ})}$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Phải là $BC = \\frac{AC}{sin B} = \\frac{7}{sin(55^{\\circ})}$.',
        },
        {
          content: '$BC = \\frac{7}{sin(55^{\\circ})}$',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. Cạnh góc vuông (AC) = Cạnh huyền (BC) $\\times$ sin góc đối (sin B) $\\implies BC = AC / sin B$.',
        },
      ],
    ...
    // =================================================================
    {
      ...
      answers: [
        {
          content: 'Tia nhìn xuống dưới và phương thẳng đứng.',
          is_correct: false,
        },
        {
          content: 'Tia nhìn lên trên và phương thẳng đứng.',
          is_correct: false,
        },
        {
          content: 'Tia nhìn lên trên và phương nằm ngang.',
          is_correct: true,
          explaination:
            'Góc nâng là góc tạo bởi tia nhìn lên (ví dụ: nhìn đỉnh tháp) và tia nằm ngang (hướng nhìn ngang của mắt).',
        },
        {
          content: 'Tia nhìn xuống dưới và phương nằm ngang.',
          is_correct: false,
          explaination: 'Đây là định nghĩa góc hạ (góc nghiêng xuống).',
        },
      ],
    },
    {
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Góc hạ là góc tạo bởi tia nhìn xuống (ví dụ: nhìn chân tháp) và tia nằm ngang (hướng nhìn ngang của mắt).',
        },
        {
          content: 'Tia nhìn lên trên và phương nằm ngang.',
          is_correct: false,
          explaination: 'Đây là định nghĩa góc nâng (góc nghiêng lên).',
        },
        {
          content: 'Tia nhìn xuống dưới và phương thẳng đứng.',
          is_correct: false,
    ...
    {
      content:
        'Một máy bay cất cánh, bay lên theo đường thẳng AB tạo với phương ngang $AC$ một góc $20^{\\circ}$. Sau 5 giây, máy bay ở độ cao $BC = 110$ m. Tính quãng đường AB máy bay đã bay (làm tròn đến mét).',
      explaination:
        'Xét tam giác ABC vuông tại C. Ta có $BC$ là cạnh đối, $AB$ là cạnh huyền của góc $20^{\\circ}$. Dùng $sin(20^{\\circ}) = \\frac{BC}{AB}$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Ta có $sin(20^{\\circ}) = \\frac{BC}{AB} \\implies AB = \\frac{BC}{sin(20^{\\circ})} = \\frac{110}{sin(20^{\\circ})} \\approx \\frac{110}{0.342} \\approx 321.6$ m. Làm tròn là 322 m.',
        },
        {
          content: '302 m',
          is_correct: false,
          explaination:
            'Bạn có thể đã dùng $AB = \\frac{BC}{tan(20^{\\circ})}$.',
        },
        {
          content: '117 m',
          is_correct: false,
          explaination:
            'Bạn có thể đã dùng $AB = \\frac{BC}{cos(20^{\\circ})}$.',
        },
        {
          content: '40 m',
          is_correct: false,
          explaination: 'Bạn có thể đã dùng $AB = BC \\cdot tan(20^{\\circ})$.',
        },
      ],
    },
    {
      content:
        'Để đo chiều cao một cái cây, bạn Hoàng đứng cách cây 6m và đo được góc nâng (góc nhìn lên đỉnh cây) là $38^{\\circ}$. Biết mắt bạn Hoàng cách mặt đất 1.64m. Tính chiều cao của cây (làm tròn hàng phần trăm).',
      explaination:
        'Gọi chiều cao cây là $AH = AD + DH$. Ta có $DH = 1.64$m. $AD$ là cạnh đối của góc $38^{\\circ}$ trong tam giác vuông ADC, với cạnh kề $CD = 6$m. $AD = CD \\cdot tan(38^{\\circ})$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '4.69 m',
          is_correct: false,
          explaination: 'Đây là chiều cao $AD$ từ tầm mắt lên đỉnh cây.',
        },
        {
          content: '7.64 m',
          is_correct: false,
          explaination: 'Bạn đã cộng <b>sai</b> $6 + 1.64$.',
        },
        {
          content: '6.33 m',
          is_correct: true,
          explaination:
            'Chiều cao $AD = 6 \\cdot tan(38^{\\circ}) \\approx 6 \\cdot 0.7813 \\approx 4.6878$ m. Chiều cao cây $AH = AD + 1.64 \\approx 4.6878 + 1.64 = 6.3278$ m. Làm tròn là 6.33 m.',
        },
        {
          content: '4.72 m',
          is_correct: false,
          explaination: 'Bạn đã dùng $AD = 6 \\cdot sin(38^{\\circ})$.',
        },
      ],
    },
    {
      content:
        'Một con sông rộng 100m. Một chiếc thuyền đi thẳng từ bờ B sang bờ C, bị dòng nước đẩy xiên một góc $35^{\\circ}$ (góc $\\hat{ABC}$). Tính quãng đường $BC$ thuyền đã đi (làm tròn hàng phần mười).',
      explaination:
        'Xét tam giác ABC vuông tại A (với AB là chiều rộng sông). $AB$ là cạnh kề, $BC$ là cạnh huyền của góc $\\hat{ABC} = 35^{\\circ}$. Ta có $cos(35^{\\circ}) = \\frac{AB}{BC}$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '174.3 m',
          is_correct: false,
          explaination: 'Bạn đã dùng $BC = AB / sin(35^{\\circ})$.',
        },
        {
          content: '122.1 m',
          is_correct: true,
          explaination:
            '$cos(35^{\\circ}) = \\frac{AB}{BC} \\implies BC = \\frac{AB}{cos(35^{\\circ})} = \\frac{100}{cos(35^{\\circ})} \\approx \\frac{100}{0.819} \\approx 122.07$ m. Làm tròn là 122.1 m.',
        },
        {
          content: '70.0 m',
          is_correct: false,
          explaination: 'Bạn đã dùng $BC = AB \\cdot tan(35^{\\circ})$.',
        },
        {
          content: '81.9 m',
          is_correct: false,
          explaination: 'Bạn đã dùng $BC = AB \\cdot cos(35^{\\circ})$.',
        },
      ],
    },
    {
      content:
        'Để đo khoảng cách giữa hai điểm B và C qua một cái hồ (không đo trực tiếp được), người ta chọn điểm A sao cho $\\hat{ACB}$ là góc vuông và đo được $AC = 4$m, $\\hat{BAC} = 81^{\\circ}$. Khoảng cách BC là:',
      explaination:
        'Xét tam giác ABC vuông tại C. $BC$ là cạnh đối, $AC$ là cạnh kề của góc $\\hat{BAC} = 81^{\\circ}$. Ta dùng $tan(A) = \\frac{BC}{AC}$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$4 \\cdot sin(81^{\\circ}) \\approx 3.95$ m',
          is_correct: false,
        },
        {
          content: '$4 \\cdot cos(81^{\\circ}) \\approx 0.63$ m',
          is_correct: false,
        },
        {
          content: '$4 \\cdot tan(81^{\\circ}) \\approx 25.26$ m',
          is_correct: true,
          explaination:
            '$BC = AC \\cdot tan(A) = 4 \\cdot tan(81^{\\circ}) \\approx 4 \\cdot 6.3138 \\approx 25.26$ m.',
        },
        {
          content: '$4 / tan(81^{\\circ}) \\approx 0.63$ m',
          is_correct: false,
        },
      ],
    }, // --- Hard ---
    {
      content:
        'Từ đỉnh tháp hải đăng cao 149m, một người quan sát thấy du thuyền ở góc hạ $27^{\\circ}$. Hỏi thuyền cách chân hải đăng bao nhiêu mét? (làm tròn hàng đơn vị)',
      explaination:
        'Góc hạ $27^{\\circ}$ bằng góc nâng từ thuyền lên đỉnh tháp (so le trong). Gọi $h=149$m là chiều cao (cạnh đối), $d$ là khoảng cách (cạnh kề). Ta có $tan(27^{\\circ}) = \\frac{h}{d}$.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '76 m',
          is_correct: false,
          explaination: 'Bạn đã dùng $d = h \\cdot tan(27^{\\circ})$.',
        },
        {
          content: '328 m',
          is_correct: false,
          explaination: 'Bạn đã dùng $d = h / sin(27^{\\circ})$.',
        },
        {
          content: '167 m',
          is_correct: false,
          explaination: 'Bạn đã dùng $d = h / cos(27^{\\circ})$.',
        },
        {
          content: '292 m',
          is_correct: true,
          explaination:
            '$d = \\frac{h}{tan(27^{\\circ})} = \\frac{149}{tan(27^{\\circ})} \\approx \\frac{149}{0.5095} \\approx 292.44$ m. Làm tròn là 292 m.',
        },
      ],
    },
    {
      content:
        'Để đo chiều cao tháp Eiffel, người ta đo tại hai điểm A, B cách nhau 101m (B gần tháp hơn) và thẳng hàng với chân tháp C. Góc nâng tới đỉnh tháp D từ A là $60^{\\circ}$, từ B là $75^{\\circ}$. Tính chiều cao $h=CD$ (làm tròn hàng đơn vị).',
      explaination:
        'Đặt $BC = x$. Ta có $h = x \\cdot tan(75^{\\circ})$ và $h = (x+101) \\cdot tan(60^{\\circ})$. Giải hệ phương trình này để tìm $h$.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
    ...
    {
      content:
        'Để đo chiều cao $AD$ của một ngọn tháp (như Hình 32, CD_1.pdf), người ta đo khoảng cách đến chân tháp $a = OB$, chiều cao giác kế $b = OC$ và góc nâng $\\alpha = \\hat{AOB}$. Công thức nào sau đây tính chiều cao $AD$ là <b>ĐÚNG</b>?',
      explaination:
        'Chiều cao tháp $AD$ bằng tổng của phần $AB$ (tính được từ tam giác vuông OAB) và chiều cao giác kế $b = BD$ (lưu ý $BD = OC$). Ta có $AB = OB \\cdot tan(\\alpha) = a \\cdot tan(\\alpha)$. Vậy $AD = AB + BD = a \\cdot tan(\\alpha) + b$.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '$AD = a \\cdot tan(\\alpha) + b$',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. $AD = AB + BD = (a \\cdot tan(\\alpha)) + b$.',
        },
        {
          content: '$AD = a \\cdot tan(\\alpha)$',
          is_correct: false,
          explaination:
            '<b>Sai</b>. Đây mới chỉ là $AB$, chưa cộng chiều cao giác kế $b$.',
        },
        {
          content: '$AD = a \\cdot sin(\\alpha) + b$',
          is_correct: false,
          explaination: '<b>Sai</b>. Dùng $tan$ chứ không phải $sin$.',
        },
        {
          content: '$AD = b \\cdot tan(\\alpha) + a$',
          is_correct: false,
          explaination: '<b>Sai</b>. Nhầm lẫn giữa $a$ và $b$.',
        },
      ],
    ...
    }, // --- Hard ---
    {
      ...
      answers: [
        ...
        },
        {
          content: '41 m',
          is_correct: false,
          explaination: 'Độ dài dây cung không thể lớn hơn đường kính (40 m).',
        },
      ],
    },
    {
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Đây là điều kiện để đường thẳng và đường tròn cắt nhau.',
        },
        {
          content: '$d = R$',
          is_correct: false,
    ...
    {
      content: 'Đường tròn nội tiếp tam giác là đường tròn:',
      explaination:
    ...
    {
      content: 'Tâm I của đường tròn nội tiếp tam giác ABC là giao điểm của:',
      explaination:
    ...
    // ========================================================
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Góc vuông là góc $90^{\\circ}$, không phụ thuộc vị trí đỉnh.',
        },
        {
    ...
    },
    {
      ...
      explaination: 'Số đo của cung nhỏ bằng số đo của góc ở tâm chắn cung đó.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            '$\\text{sđ } \\overparen{AB} = \\widehat{AOB} = 80^{\\circ}$.',
        },
        {
          content: '$160^{\\circ}$',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Đây là số đo cung lớn AB ($360^{\\circ} - 80^{\\circ}$).',
        },
      ],
    },
    {
      content: 'Góc nội tiếp của đường tròn (O) là góc có:',
      explaination:
    ...
    }, // --- Medium ---
    {
      ...
      explaination: 'Số đo của góc nội tiếp bằng nửa số đo của cung bị chắn.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Đây là số đo cung lớn AC ($360^{\\circ} - 120^{\\circ}$).',
        },
        {
          content: '$60^{\\circ}$',
          is_correct: false,
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Số đo cung lớn = $360^{\\circ} - 100^{\\circ} = 260^{\\circ}$.',
        },
        {
          content:
        ...
        {
          content:
            'Góc nội tiếp $\\widehat{MPN}$ (P thuộc cung nhỏ) bằng $50^{\\circ}$.',
          is_correct: false,
          explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Chỉ đúng nếu $C=60^{\\circ}$, nhưng ở đây $C=90^{\\circ}$.',
        },
        {
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'O là tâm, O, A, B thẳng hàng. OAC và OBC là tam giác cân.',
        },
        {
    ...
    },
    {
      ...
      answers: [
        {
          content:
            '$\\text{sđ } \\overparen{AC} + \\text{sđ } \\overparen{BD} = 180^{\\circ}$',
          is_correct: true,
          explaination:
        ...
        {
          content:
            '$\\text{sđ } \\overparen{AC} = \\text{sđ } \\overparen{BD}$',
          is_correct: false,
          explaination: 'Chỉ đúng khi $AB=CD$ hoặc H là tâm.',
        },
        {
          content:
            '$\\text{sđ } \\overparen{AC} + \\text{sđ } \\overparen{BD} = 90^{\\circ}$',
          is_correct: false,
          explaination:
            'Đây là tổng của hai góc nội tiếp, không phải tổng cung.',
        },
        {
          content: '$AB = CD$',
          is_correct: false,
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            '$S = \\frac{15 \\times 6}{2} = \\frac{90}{2} = 45 \\text{ cm}^2$.',
        },
        {
    ...
    {
      content:
        'Loại biểu đồ nào thích hợp nhất để biểu diễn tỉ lệ phần trăm của các phần trong một tổng thể?',
      explaination:
        'Biểu đồ hình quạt tròn được thiết kế để thể hiện tỉ lệ của từng phần so với tổng thể (100%).',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Biểu đồ cột thường dùng để so sánh độ lớn giữa các đại lượng.',
        },
        {
          content: 'Biểu đồ đoạn thẳng',
          is_correct: false,
          explaination:
            'Biểu đồ đoạn thẳng thường dùng để thể hiện xu hướng thay đổi theo thời gian.',
        },
        {
          content: 'Biểu đồ hình quạt tròn',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. Biểu đồ hình quạt tròn (pie chart) chia hình tròn thành các phần, mỗi phần biểu thị một tỉ lệ phần trăm của tổng thể.',
        },
        {
          content: 'Bảng dữ liệu',
          is_correct: false,
          explaination:
            'Bảng dữ liệu dùng để liệt kê số liệu thô, không phải biểu diễn tỉ lệ một cách trực quan.',
        },
      ],
    },
    {
      ...
      explaination:
        'Mục đích chính của biểu đồ cột là so sánh giá trị của các hạng mục khác nhau một cách trực quan.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: 'Thể hiện xu hướng tăng/giảm theo thời gian',
          is_correct: false,
          explaination: 'Đây là công dụng chính của biểu đồ đoạn thẳng.',
        },
        {
          content: 'So sánh độ lớn của các đại lượng',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. Độ cao của các cột cho phép so sánh trực quan xem đại lượng nào lớn hơn hay nhỏ hơn.',
        },
        {
          content: 'Biểu diễn tỉ lệ phần trăm của tổng thể',
          is_correct: false,
          explaination: 'Đây là công dụng chính của biểu đồ hình quạt tròn.',
        },
        {
          content: 'Liệt kê chi tiết từng số liệu',
          is_correct: false,
          explaination: 'Đây là công dụng của bảng thống kê.',
        },
      ],
    },
    {
      content:
        'Loại biểu đồ nào phù hợp để biểu diễn sự thay đổi của nhiệt độ theo thời gian (ví dụ: trong 7 ngày)?',
      explaination:
        'Biểu đồ đoạn thẳng (line chart) rất hiệu quả trong việc thể hiện xu hướng (trend) của dữ liệu theo một chuỗi thời gian.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: 'Biểu đồ hình quạt tròn',
          is_correct: false,
          explaination: 'Không phù hợp để biểu diễn sự thay đổi liên tục.',
        },
        {
          content: 'Biểu đồ cột kép',
          is_correct: false,
          explaination:
            'Dùng để so sánh 2 bộ dữ liệu song song, không phải xu hướng.',
        },
        {
          content: 'Biểu đồ đoạn thẳng',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. Biểu đồ đoạn thẳng nối các điểm dữ liệu theo thời gian, cho thấy rõ sự tăng/giảm.',
        },
        {
          content: 'Bảng tần số',
          is_correct: false,
          explaination:
            'Bảng tần số chỉ cho biết số lần xuất hiện, không thể hiện xu hướng.',
        },
      ],
    }, // --- Medium ---
    {
      content:
        'Một biểu đồ hình quạt tròn biểu diễn tỉ lệ học lực của lớp 9A. Biết 50% là học lực Tốt, 30% là Khá, 20% là Trung bình. Góc ở tâm của hình quạt biểu diễn học lực Khá là bao nhiêu độ?',
      explaination:
        'Một vòng tròn đầy đủ là $360^{\\circ}$. Góc ở tâm tương ứng với 30% là $30\\% \\times 360^{\\circ}$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        ...
        },
        {
          content: '$180^{\\circ}$',
          is_correct: false,
          explaination: 'Đây là góc của học lực Tốt (50%).',
        },
        {
          content: '$72^{\\circ}$',
          is_correct: false,
          explaination: 'Đây là góc của học lực Trung bình (20%).',
        },
        {
          content: '$108^{\\circ}$',
          is_correct: true,
          explaination:
            'Góc ở tâm = $30\\% \\times 360^{\\circ} = 0.3 \\times 360^{\\circ} = 108^{\\circ}$.',
        },
      ],
    },
    {
      content:
        'Biểu đồ cột dưới đây cho thấy số lượng học sinh tham gia 4 câu lạc bộ: Toán (30), Anh (50), Nhạc (40), Thể thao (30). Chọn các nhận xét <b>ĐÚNG</b> (chọn nhiều đáp án).',
      ...
      answers: [
        {
          content: 'CLB Anh có nhiều học sinh tham gia nhất.',
          is_correct: true,
          explaination: '<b>Đúng</b>. CLB Anh có 50 HS, cao nhất.',
        },
        {
          content: 'CLB Toán và Thể thao có số lượng HS bằng nhau.',
          is_correct: true,
          explaination: '<b>Đúng</b>. Cả hai CLB đều có 30 HS.',
        },
        {
          content: 'CLB Nhạc có ít học sinh tham gia nhất.',
          is_correct: false,
          explaination:
            '<b>Sai</b>. CLB Nhạc (40 HS) nhiều hơn Toán và Thể thao (30 HS).',
        },
        {
          content: 'Tổng số học sinh tham gia là 100.',
          is_correct: false,
          explaination: '<b>Sai</b>. Tổng là $30 + 50 + 40 + 30 = 150$ HS.',
        },
      ],
    },
    {
      content:
        'Bảng thống kê điểm kiểm tra Toán của tổ 1: { 7, 8, 8, 9, 10, 7, 6, 8 }. Mốt (Mode) của mẫu số liệu này là gì?',
      explaination:
        'Mốt (Mode) của mẫu số liệu là giá trị có tần số xuất hiện cao nhất trong mẫu.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '10',
          is_correct: false,
          explaination: 'Điểm 10 chỉ xuất hiện 1 lần.',
        },
        {
          content: '8',
          is_correct: true,
          explaination:
            'Điểm 6 (1 lần), Điểm 7 (2 lần), Điểm 8 (3 lần), Điểm 9 (1 lần), Điểm 10 (1 lần). Giá trị 8 xuất hiện nhiều nhất (3 lần).',
        },
        {
          content: '7.5',
          is_correct: false,
          explaination: 'Đây là giá trị trung bình (Mean).',
        },
        {
          content: '3',
          is_correct: false,
          explaination: 'Đây là tần số của mốt, không phải giá trị mốt.',
        },
      ],
    }, // --- Hard ---
    {
      content:
        'Bảng thống kê cho biết lớp 9A có 40 học sinh. Biểu đồ quạt biểu diễn tỉ lệ xếp loại học lực, trong đó học lực Tốt chiếm $108^{\\circ}$. Lớp 9A có bao nhiêu học sinh học lực Tốt?',
      explaination:
        'Tỉ lệ % của học lực Tốt = $\\frac{\\text{Góc ở tâm}}{360^{\\circ}}$. Số học sinh = Tỉ lệ % $\times$ Tổng số học sinh.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '10 học sinh',
          is_correct: false,
          explaination: 'Kiểm tra lại phép tính tỉ lệ.',
        },
        {
          content: '12 học sinh',
          is_correct: true,
          explaination:
            'Tỉ lệ % học lực Tốt = $\\frac{108^{\\circ}}{360^{\\circ}} = 0.3 = 30\\%$. Số học sinh Tốt = $30\\% \\times 40 = 0.3 \\times 40 = 12$ học sinh.',
        },
        {
          content: '15 học sinh',
          is_correct: false,
        ...
        },
        {
          content: '30 học sinh',
          is_correct: false,
          explaination: 'Đây là tỉ lệ phần trăm (30%).',
        },
      ],
    },
    {
      content:
        'Biểu đồ đoạn thẳng cho thấy nhiệt độ các ngày trong tuần: T2(28), T3(30), T4(29), T5(32), T6(31), T7(33), CN(32). Chọn các nhận xét <b>ĐÚNG</b> (chọn nhiều đáp án).',
      explaination:
        'Phân tích dữ liệu để tìm xu hướng tăng/giảm và giá trị lớn nhất/nhỏ nhất.',
      level: DifficultyLevel.hard,
      type: QuestionType.multiple_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: 'Nhiệt độ có xu hướng tăng dần trong tuần.',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. Mặc dù có giảm nhẹ vào T4, xu hướng chung là tăng từ 28 (T2) lên 33 (T7).',
        },
        {
          content: 'Ngày nóng nhất là Chủ Nhật.',
          is_correct: false,
          explaination: '<b>Sai</b>. Ngày nóng nhất là Thứ Bảy (33 độ).',
        },
        {
          content: 'Nhiệt độ T5 tăng $3^{\\circ}$C so với T4.',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. Nhiệt độ T5 là $32^{\\circ}$, T4 là $29^{\\circ}$. $32 - 29 = 3$.',
        },
        {
          content: 'Ngày mát nhất là Thứ Hai.',
          is_correct: true,
          explaination:
            '<b>Đúng</b>. Thứ Hai có nhiệt độ thấp nhất là $28^{\\circ}$.',
        },
      ],
    },
    {
      content:
        'Biểu đồ cột kép cho thấy số học sinh Nam và Nữ của hai lớp 9A và 9B. 9A (Nam: 20, Nữ: 25), 9B (Nam: 24, Nữ: 20). Tổng số học sinh của hai lớp là bao nhiêu?',
      explaination:
        'Cần cộng tất cả học sinh (cả Nam và Nữ) của cả hai lớp lại.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          content: '45',
          is_correct: false,
          explaination: 'Đây là tổng số học sinh lớp 9A.',
        },
        {
          content: '44',
          is_correct: false,
          explaination: 'Đây là tổng số học sinh lớp 9B.',
        },
        {
          content: '89',
          is_correct: true,
          explaination:
            'Tổng số HS = (HS 9A) + (HS 9B) = (20 + 25) + (24 + 20) = 45 + 44 = 89.',
        },
        {
          content: '44 (Nam) và 45 (Nữ)',
          is_correct: false,
          explaination: 'Đây là tổng số Nam và Nữ, không phải tổng chung.',
        },
      ],
    ...
    {
      content:
        'Số lần xuất hiện của một giá trị trong mẫu dữ liệu thống kê được gọi là gì?',
      explaination:
    ...
    {
      content: 'Trong một mẫu số liệu, tổng tất cả các tần số $n_i$ bằng:',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Ví dụ: Lớp 9C có $N=40$ học sinh, và $n_1+...+n_5 = 6+8+10+12+4 = 40$.',
        },
        {
          content: '100',
          is_correct: false,
    ...
    }, // --- Hard ---
    {
      ...
      explaination: 'Ta có $f = 20\\%$ và $N=30$. Tần số $n = f \\times N$.',
      level: DifficultyLevel.hard,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
    ...
    {
      content:
        'Trong các hàm số sau, hàm số nào có dạng $y = ax^2$ ($a \\ne 0$) với $a = \\frac{1}{3}$?',
      explaination: 'Tìm hàm số chỉ chứa $x^2$ và xác định hệ số $a$ của nó.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Hàm số này có thể viết là $y = \\frac{1}{3}x^2$, có hệ số $a = 1/3$.',
        },
        {
          content: '$y = x^2 + \\frac{1}{3}$',
          is_correct: false,
          explaination:
            'Đây không phải là hàm số dạng $y = ax^2$ do có hằng số tự do.',
        },
        {
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Bạn có thể đã quên dấu âm của hệ số $a$. $y = -4(4) = -16$.',
        },
        {
          content: '32',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Thay $x = -2$ vào, ta có $y = -4(-2)^2 = -4(4) = -16$.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Khi $x = 0$, ta luôn có $y = a(0)^2 = 0$, bất kể giá trị $a$.',
        },
        {
          content: 'Điểm $(1, 1)$',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Điểm này thuộc đồ thị, nhưng không phải là điểm *luôn* đi qua cho mọi $a$ (ví dụ $a$ thay đổi thì điểm này thay đổi).',
        },
        {
          content: 'Điểm $(0, a)$',
          is_correct: false,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Hệ số $a = 0.5 > 0$ nên đồ thị nằm phía trên trục hoành.',
        },
        {
          content: 'Gốc tọa độ O là điểm cao nhất của đồ thị.',
          is_correct: false,
          explaination:
            'Vì $a > 0$, đồ thị quay bề lõm lên trên, nên O là điểm thấp nhất.',
        },
        {
          content: 'Đồ thị nằm phía trên trục hoành.',
          is_correct: true,
          explaination:
            'Hệ số $a = 0.5 > 0$, và $x^2 \\ge 0$, nên $y = 0.5x^2 \\ge 0$ với mọi $x$.',
        },
        {
          content: 'Đồ thị không đối xứng qua trục Oy.',
          is_correct: false,
          explaination:
            'Đồ thị hàm số $y=ax^2$ luôn nhận trục Oy làm trục đối xứng.',
        },
      ],
    },
    {
      content:
        'Đồ thị (P) của hàm số $y = ax^2$ đi qua điểm $M(2, -8)$. Hệ số $a$ bằng:',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Thay vào ta có: $-8 = a(2)^2 \\implies -8 = 4a \\implies a = -2$.',
        },
        {
          content: '-2',
          is_correct: true,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Nếu $x=1$, $y = -3(1)^2 = -3$. Điểm $(1, -3)$ mới thuộc đồ thị.',
        },
        {
          content: '$C(-1, 3)$',
          is_correct: false,
          explaination:
            'Điểm $A(-1, -3)$ đã thuộc đồ thị, điểm này có cùng hoành độ nhưng khác tung độ.',
        },
        {
          content: '$D(1, -3)$',
          is_correct: true,
          explaination:
            'Do đồ thị đối xứng qua trục Oy, điểm $A(-1, -3)$ thuộc đồ thị thì điểm $D(1, -3)$ (là điểm đối xứng của A qua Oy) cũng thuộc đồ thị.',
        },
        {
          content: '$E(3, -9)$',
          is_correct: false,
          explaination:
            'Nếu $x=3$, $y = -3(3)^2 = -27$. Điểm $(3, -27)$ mới thuộc đồ thị.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Thay $x=2$: $y = \\frac{1}{2}(2)^2 = \\frac{1}{2}(4) = 2$. Tọa độ $(2, 2)$ thỏa mãn. Điểm $M(2, 2)$ thuộc đồ thị.',
        },
        {
          content: '$N(-1, \\frac{1}{2})$',
          is_correct: true,
          explaination:
            'Thay $x=-1$: $y = \\frac{1}{2}(-1)^2 = \\frac{1}{2}(1) = \\frac{1}{2}$. Tọa độ $(-1, \\frac{1}{2})$ thỏa mãn. Điểm $N(-1, \\frac{1}{2})$ thuộc đồ thị.',
        },
        {
          content: '$P(4, 4)$',
          is_correct: false,
          explaination:
            'Thay $x=4$: $y = \\frac{1}{2}(4)^2 = \\frac{1}{2}(16) = 8$. Tọa độ $(4, 4)$ không thỏa mãn.',
        },
        {
          content: '$Q(-6, -18)$',
          is_correct: false,
          explaination:
            'Thay $x=-6$: $y = \\frac{1}{2}(-6)^2 = \\frac{1}{2}(36) = 18$. Tọa độ $(-6, -18)$ không thỏa mãn.',
        },
      ],
    }, // --- Hard ---
    {
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Ta có $125 = 5x^2 \\implies x^2 = 125 / 5 = 25$. Đây là $x^2$, không phải $x$.',
        },
        {
          content: '5 giây',
          is_correct: true,
          explaination:
            'Ta giải $125 = 5x^2 \\implies x^2 = 25$. Vì $x > 0$ (thời gian) nên $x = \\sqrt{25} = 5$ giây.',
        },
        {
          content: '10 giây',
          is_correct: false,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Nếu $a=-2$, khi $x=2$, $y = -2(2)^2 = -8$, không phải -25.',
        },
        {
          content: '$y = -12.5x^2$',
          is_correct: false,
          explaination:
            'Nếu $a=-12.5$, khi $x=2$, $y = -12.5(2)^2 = -50$, không phải -25.',
        },
        {
          content: '$y = -6.25x^2$',
          is_correct: true,
    ...
    // ====================================================================
    {
      content: 'Phương trình nào sau đây là phương trình bậc hai một ẩn $x$?',
      explaination:
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Hệ số của $x^2$ là $a=2$, hệ số của $x$ là $b=-5$, hệ số tự do là $c=3$.',
        },
        {
          content: '$a = 2, b = 5, c = -3$',
          is_correct: false,
    ...
    {
      content:
        'Biệt thức $\\Delta$ của phương trình $ax^2 + bx + c = 0$ được tính bằng công thức:',
    ...
    {
      content: 'Phương trình $9x^2 + 6x + 1 = 0$ có nghiệm là:',
      explaination:
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Nghiệm kép $x = -b / (2a) = -6 / (2 \\times 9) = -6 / 18 = -1/3$.',
        },
        {
          content: '$x_1 = x_2 = \\frac{1}{3}$',
          is_correct: false,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đây là $\\Delta = b^2 - 4ac = (-2)^2 - 4(3)(9) = 4 - 108 = -104$.',
        },
        {
          content: '28',
          is_correct: false,
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Đây là $51/2$. Giảm giá liên tiếp không phải là phép cộng.',
        },
        {
          content: 'x = 70',
          is_correct: false,
    ...
    {
      content:
        'Cho phương trình $5x^2 - 7x - 3 = 0$. Tính tổng hai nghiệm $x_1 + x_2$.',
      explaination:
    ...
    }, // --- Medium ---
    {
      ...
      explaination: 'Kiểm tra các trường hợp đặc biệt: $a+b+c$ và $a-b+c$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Phương trình có $a=3, b=-4, c=1$. Ta thấy $a+b+c = 3 + (-4) + 1 = 0$. Vậy $x_1 = 1$ và $x_2 = c/a = 1/3$.',
        },
        {
          content: '$x_1 = -1; x_2 = -\\frac{1}{3}$',
          is_correct: false,
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Phương trình có $a=2, b=5, c=3$. Ta thấy $a-b+c = 2 - 5 + 3 = 0$. Vậy $x_1 = -1$ và $x_2 = -c/a = -3/2$.',
        },
        {
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Ta giải $x^2 - 7x + 12 = 0$. Nhẩm $a+b+c$ không được. $\\Delta = (-7)^2 - 4(1)(12) = 49 - 48 = 1$. Nghiệm là $x_1 = (7+1)/2 = 4$ và $x_2 = (7-1)/2 = 3$.',
        },
        {
          content: '-3 và -4',
          is_correct: false,
    ...
    {
      content:
        'Một nhà kính trồng hoa hình chữ nhật có độ dài hàng rào bao quanh là 68 m và diện tích trồng hoa là $240 m^2$. Chiều dài và chiều rộng của nhà kính là nghiệm của phương trình nào?',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Nhầm lẫn $S$ là chu vi. $S$ là nửa chu vi (tổng hai số).',
        },
        {
          content: '$x^2 - 34x + 240 = 0$',
          is_correct: true,
          explaination:
            'Tổng $S = 68/2 = 34$. Tích $P = 240$. Phương trình là $x^2 - 34x + 240 = 0$.',
        },
        {
          content: '$x^2 + 34x - 240 = 0$',
          is_correct: false,
    ...
    {
      content:
        'Cho phương trình $2x^2 - 3x - 6 = 0$. Không giải phương trình, hãy tính giá trị của biểu thức $A = \\frac{1}{x_1} + \\frac{1}{x_2}$.',
      explaination:
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            '$A = S/P = (3/2) / (-3) = 3 / (2 \\times -3) = 3 / (-6) = -1/2$.',
        },
        {
          content: '$-2$',
          is_correct: false,
    ...
    {
      content:
        'Cho phương trình $x^2 - 4x + 1 = 0$ có hai nghiệm $x_1, x_2$. Các khẳng định nào sau đây là đúng? (Chọn nhiều đáp án)',
      explaination:
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            '$x_1^2 + x_2^2 = S^2 - 2P = (4)^2 - 2(1) = 16 - 2 = 14$.',
        },
        {
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Theo định nghĩa, đường tròn đi qua ba đỉnh của tam giác là đường tròn ngoại tiếp tam giác đó.',
        },
        {
          content: 'Đường tròn nội tiếp tam giác.',
          is_correct: false,
          explaination:
            'Đường tròn nội tiếp là đường tròn tiếp xúc với ba cạnh của tam giác, không phải đi qua ba đỉnh.',
        },
        {
          content: 'Đường tròn bàng tiếp tam giác.',
          is_correct: false,
          explaination:
            'Đường tròn bàng tiếp chỉ tiếp xúc với một cạnh và phần kéo dài của hai cạnh kia.',
        },
        {
          content: 'Đường tròn cơ sở của tam giác.',
          is_correct: false,
          explaination:
            'Đây không phải là một thuật ngữ chuẩn trong hình học phẳng liên quan đến tam giác.',
        },
      ],
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Theo định nghĩa, đường tròn tiếp xúc với ba cạnh của tam giác là đường tròn nội tiếp tam giác đó.',
        },
        {
          content: 'Đường tròn bàng tiếp tam giác.',
          is_correct: false,
          explaination:
            'Đường tròn bàng tiếp cũng tiếp xúc với ba đường thẳng chứa ba cạnh, nhưng chỉ tiếp xúc trong với một cạnh.',
        },
        {
          content: 'Đường tròn tâm O.',
          is_correct: false,
          explaination:
            'Đây là cách gọi tên một đường tròn bất kỳ, không mô tả mối quan hệ của nó với tam giác.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Giao điểm ba đường phân giác là tâm của đường tròn nội tiếp, vì nó cách đều ba cạnh.',
        },
        {
          content: 'Ba đường trung tuyến.',
          is_correct: false,
          explaination:
            'Giao điểm ba đường trung tuyến là trọng tâm của tam giác.',
        },
        {
          content: 'Ba đường cao.',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Tâm đường tròn ngoại tiếp cách đều ba đỉnh. Mọi điểm trên đường trung trực của $AB$ thì cách đều $A$ và $B$. Tương tự cho $BC$ và $AC$. Do đó, giao điểm của ba đường trung trực cách đều cả ba đỉnh $A, B, C$.',
        },
      ],
    }, // --- Medium ---
    {
      content:
        'Tâm của đường tròn nội tiếp tam giác là giao điểm của ba đường nào?',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Tâm đường tròn nội tiếp cách đều ba cạnh. Mọi điểm trên đường phân giác của góc $A$ thì cách đều hai cạnh $AB$ và $AC$. Do đó, giao điểm của ba đường phân giác cách đều cả ba cạnh $AB, BC, CA$.',
        },
        {
          content: 'Ba đường trung tuyến.',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Giao điểm ba đường trung trực là tâm của đường tròn ngoại tiếp, vì nó cách đều ba đỉnh.',
        },
      ],
    },
    {
      content:
        'Cho tam giác ABC vuông tại A. Tâm đường tròn ngoại tiếp của tam giác ABC nằm ở đâu?',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đỉnh A là một trong ba đỉnh tam giác, nó không thể cách đều cả ba đỉnh (khoảng cách từ A đến A là 0).',
        },
        {
          content: 'Trung điểm cạnh huyền BC.',
          is_correct: true,
          explaination:
            'Gọi $O$ là trung điểm cạnh huyền $BC$. Ta có $OA = OB = OC = \\frac{1}{2}BC$ (tính chất đường trung tuyến ứng với cạnh huyền). Vì $O$ cách đều $A, B, C$ nên $O$ là tâm đường tròn ngoại tiếp.',
        },
        {
          content: 'Trung điểm cạnh góc vuông AB.',
          is_correct: false,
          explaination:
            'Trung điểm của $AB$ chỉ cách đều $A$ và $B$, không cách đều $C$ (trừ trường hợp đặc biệt không thể xảy ra).',
        },
        {
          content: 'Trọng tâm tam giác.',
          is_correct: false,
          explaination:
            'Trọng tâm chỉ trùng với tâm đường tròn ngoại tiếp trong trường hợp tam giác đều, mà tam giác này vuông.',
        },
      ],
    },
    {
      content:
        'Đối với một tam giác đều, khẳng định nào sau đây là đúng? (Chọn nhiều đáp án)',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Do các đường trung trực và đường phân giác trùng nhau, nên giao điểm của chúng (tâm ngoại tiếp và tâm nội tiếp) cũng trùng nhau.',
        },
        {
          content:
            'Trọng tâm, trực tâm, tâm đường tròn ngoại tiếp, tâm đường tròn nội tiếp là bốn điểm phân biệt.',
          is_correct: false,
          explaination:
            'Ngược lại, trong tam giác đều, bốn điểm này trùng làm một.',
        },
        {
          content: 'Trọng tâm của tam giác là tâm đường tròn ngoại tiếp.',
          is_correct: true,
          explaination:
            'Trong tam giác đều, đường trung tuyến cũng là đường trung trực, nên trọng tâm (giao 3 trung tuyến) cũng là tâm đường tròn ngoại tiếp (giao 3 trung trực).',
        },
        {
          content: 'Tâm đường tròn ngoại tiếp luôn nằm ngoài tam giác.',
          is_correct: false,
          explaination:
            'Tam giác đều là tam giác nhọn, nên tâm đường tròn ngoại tiếp nằm bên trong tam giác.',
        },
      ],
    }, // --- Hard ---
    {
      content:
        'Tính bán kính $R$ của đường tròn ngoại tiếp tam giác ABC vuông tại A, biết $AB = 5$ cm, $AC = 12$ cm.',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            '13 cm là độ dài cạnh huyền $BC$. Bán kính $R$ bằng một nửa cạnh huyền.',
        },
        {
          content: '6 cm',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Áp dụng Pythagore: $BC^2 = AB^2 + AC^2 = 5^2 + 12^2 = 25 + 144 = 169$. Suy ra $BC = \\sqrt{169} = 13$ cm. Bán kính $R = BC / 2 = 13 / 2 = 6.5$ cm.',
        },
        {
          content: '8.5 cm',
          is_correct: false,
    ...
    {
      content:
        'Một tam giác đều có cạnh là $a = 6$ cm. Bán kính $R$ của đường tròn ngoại tiếp tam giác đó là:',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đây là độ dài đường cao $h = \\frac{a\\sqrt{3}}{2} = \\frac{6\\sqrt{3}}{2} = 3\\sqrt{3}$. $R$ bằng $2/3$ đường cao.',
        },
        {
          content: '$2\\sqrt{3}$ cm',
          is_correct: true,
          explaination:
            'Áp dụng công thức $R = \\frac{a\\sqrt{3}}{3} = \\frac{6\\sqrt{3}}{3} = 2\\sqrt{3}$ cm. (Cách khác: Đường cao $h = 3\\sqrt{3}$. Tâm O là trọng tâm, $R = OA = \\frac{2}{3}h = \\frac{2}{3}(3\\sqrt{3}) = 2\\sqrt{3}$).',
        },
        {
          content: '$\\sqrt{3}$ cm',
          is_correct: false,
          explaination:
            'Đây là bán kính $r$ của đường tròn nội tiếp ($r = \\frac{a\\sqrt{3}}{6}$).',
        },
        {
          content: '3 cm',
          is_correct: false,
    ...
    {
      content:
        'Một tam giác đều có cạnh là $a = 12$ cm. Bán kính $r$ của đường tròn nội tiếp tam giác đó là:',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đây là độ dài đường cao $h = \\frac{a\\sqrt{3}}{2} = \\frac{12\\sqrt{3}}{2} = 6\\sqrt{3}$. $r$ bằng $1/3$ đường cao.',
        },
        {
          content: '$4\\sqrt{3}$ cm',
          is_correct: false,
          explaination:
            'Đây là bán kính $R$ của đường tròn ngoại tiếp ($R = \\frac{a\\sqrt{3}}{3}$).',
        },
        {
          content: '$2\\sqrt{3}$ cm',
          is_correct: true,
          explaination:
            'Áp dụng công thức $r = \\frac{a\\sqrt{3}}{6} = \\frac{12\\sqrt{3}}{6} = 2\\sqrt{3}$ cm. (Cách khác: Đường cao $h = 6\\sqrt{3}$. Tâm O là trọng tâm, $r = OM = \\frac{1}{3}h = \\frac{1}{3}(6\\sqrt{3}) = 2\\sqrt{3}$).',
        },
        {
          content: '6 cm',
          is_correct: false,
    ...
    {
      content: 'Hình nào sau đây LUÔN LUÔN nội tiếp được một đường tròn?',
      explaination:
    ...
    }, // --- Medium ---
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination: 'Hai góc kề không bù nhau. Góc đối mới bù nhau.',
        },
        {
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Bạn đã tính $(8+6)/2$, đây là nửa chu vi, không phải bán kính.',
        },
        {
          content: '14 cm',
          is_correct: false,
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Hình thang chỉ là hình bình hành nếu hai đáy bằng nhau.',
        },
        {
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Chỉ đúng nếu BC là đường kính, nhưng tam giác ABC đều.',
        },
        {
          content: '$100^{\\circ}$',
          is_correct: false,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Chưa đủ. Một hình thoi có các cạnh bằng nhau nhưng chưa chắc là đa giác đều (trừ khi nó là hình vuông).',
        },
        {
          content: 'Tất cả các góc bằng nhau.',
          is_correct: false,
          explaination:
            'Chưa đủ. Một hình chữ nhật có các góc bằng nhau nhưng chưa chắc là đa giác đều (trừ khi nó là hình vuông).',
        },
        {
          content: 'Tất cả các cạnh bằng nhau và tất cả các góc bằng nhau.',
          is_correct: true,
          explaination:
            'Đây là định nghĩa chính xác. Ví dụ: hình vuông vừa có 4 cạnh bằng nhau, vừa có 4 góc bằng $90^\\circ$.',
        },
        {
          content: 'Là một đa giác lồi.',
          is_correct: false,
          explaination:
            'Đa giác đều là đa giác lồi, nhưng một đa giác lồi bất kỳ (ví dụ hình chữ nhật) chưa chắc là đa giác đều.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Tam giác đều có 3 cạnh bằng nhau và 3 góc bằng $60^\\circ$, nên là đa giác đều.',
        },
        {
          content: 'Hình vuông.',
          is_correct: false,
          explaination:
            'Hình vuông có 4 cạnh bằng nhau và 4 góc bằng $90^\\circ$, nên là đa giác đều.',
        },
        {
          content: 'Hình chữ nhật (không phải hình vuông).',
          is_correct: true,
          explaination:
            'Hình chữ nhật có các góc bằng nhau (đều bằng $90^\\circ$) nhưng các cạnh không nhất thiết bằng nhau (chiều dài $\\ne$ chiều rộng).',
        },
        {
          content: 'Lục giác đều.',
          is_correct: false,
          explaination:
            'Lục giác đều có 6 cạnh bằng nhau và 6 góc bằng $120^\\circ$, nên là đa giác đều.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đây là định nghĩa đa giác đều cạnh, ví dụ như hình thoi.',
        },
        {
          content:
            'Đa giác luôn nằm về một phía của đường thẳng chứa một cạnh bất kì của đa giác đó.',
          is_correct: true,
          explaination:
            'Đây là định nghĩa chính xác của đa giác lồi. Đa giác không lồi (đa giác lõm) sẽ bị đường thẳng chứa cạnh "cắt" thành nhiều phần.',
        },
        {
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Đây là định nghĩa của đa giác nội tiếp, không phải đa giác lồi (mặc dù đa giác nội tiếp luôn là đa giác lồi).',
        },
      ],
    }, // --- Medium ---
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Tổng các góc là $(5-2) \\times 180^\\circ = 540^\\circ$. Số đo mỗi góc là $540^\\circ / 5 = 108^\\circ$.',
        },
        {
          content: '$120^\\circ$',
          is_correct: false,
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Tổng các góc là $(6-2) \\times 180^\\circ = 720^\\circ$. Số đo mỗi góc là $720^\\circ / 6 = 120^\\circ$.',
        },
        {
          content: '$135^\\circ$',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Đây là tổng số đo các góc của lục giác, không phải số đo của một góc.',
        },
      ],
    },
    {
      content:
        'Hình ảnh tổ ong trong tự nhiên (Hình 13) có cấu trúc liên quan đến hình đa giác đều nào?',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Hình ảnh ngũ giác đều thường thấy ở bông hoa hoặc con sao biển.',
        },
        {
          content: 'Lục giác đều (Hình 6 cạnh)',
          is_correct: true,
          explaination:
            'Cấu trúc tổ ong được xây dựng từ các ô hình lục giác đều, đây là một cấu trúc rất hiệu quả về vật liệu và độ bền.',
        },
        {
          content: 'Bát giác đều (Hình 8 cạnh)',
          is_correct: false,
          explaination:
            'Hình ảnh này không liên quan đến tổ ong. Bát giác đều có thể thấy ở một số thiết kế đĩa hoặc gạch (như Hình 20).',
        },
        {
          content: 'Hình vuông (Hình 4 cạnh)',
          is_correct: false,
          explaination:
            'Hình vuông thường thấy trong các viên gạch lát nền (Hình 18).',
        },
      ],
    },
    {
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Sai. Hình chữ nhật có các góc bằng nhau ($90^\\circ$) nhưng các cạnh không nhất thiết bằng nhau.',
        },
        {
          content: 'Hình thoi là một đa giác đều.',
          is_correct: false,
          explaination:
            'Sai. Hình thoi có các cạnh bằng nhau nhưng các góc không nhất thiết bằng nhau.',
        },
        {
          content: 'Hình vuông là một đa giác đều.',
          is_correct: true,
          explaination:
            'Đúng. Hình vuông thỏa mãn cả hai điều kiện: 4 cạnh bằng nhau và 4 góc bằng nhau (đều bằng $90^\\circ$).',
        },
        {
          content: 'Tam giác đều là một đa giác đều.',
          is_correct: true,
          explaination:
            'Đúng. Tam giác đều thỏa mãn cả hai điều kiện: 3 cạnh bằng nhau và 3 góc bằng nhau (đều bằng $60^\\circ$).',
        },
      ],
    }, // --- Hard ---
    {
      content:
        'Tổng số đo các góc trong của một bát giác đều (8 cạnh) là bao nhiêu?',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Với $n=8$, ta có tổng số đo các góc là $S = (8-2) \\times 180^\\circ = 6 \\times 180^\\circ = 1080^\\circ$.',
        },
        {
          content: '$135^\\circ$',
          is_correct: false,
          explaination:
            'Đây là số đo của *một* góc trong bát giác đều, được tính bằng $1080^\\circ / 8 = 135^\\circ$. Câu hỏi yêu cầu tính *tổng* các góc.',
        },
        {
          content: '$720^\\circ$',
          is_correct: false,
    ...
    {
      content:
        'Trong Ví dụ 2 (Hình 8), tại sao hình bát giác (8 cạnh) mà bạn Thảo tạo ra được coi là một đa giác đều?',
      explaination:
      ...
      answers: [
        {
          content:
            'Vì nó được cắt ra từ một hình vuông, mà hình vuông là đa giác đều.',
          is_correct: false,
          explaination:
            'Việc cắt một đa giác đều không đảm bảo kết quả sẽ là một đa giác đều.',
        },
        {
          content: 'Vì nó có 8 cạnh.',
          is_correct: false,
          explaination:
            'Việc có 8 cạnh chỉ khiến nó trở thành một bát giác, không phải là một bát giác *đều*.',
        },
        {
          content:
            'Vì cách gấp và cắt đối xứng tạo ra 8 cạnh bằng nhau và 8 góc bằng nhau.',
          is_correct: true,
          explaination:
            'Quá trình gấp giấy (Hình 8a, 8b, 8c) đảm bảo tính đối xứng. Nhát cắt (Hình 8d) tạo ra 8 tam giác cân bằng nhau khi mở ra (Hình 8e), dẫn đến 8 cạnh (cạnh đáy tam giác) bằng nhau và 8 góc ở đỉnh (bằng nhau) tạo thành bát giác đều.',
        },
        {
          content: 'Vì nó có tâm đối xứng O.',
          is_correct: false,
          explaination:
            'Một đa giác đều (với số cạnh chẵn) có tâm đối xứng, nhưng một đa giác có tâm đối xứng (ví dụ hình chữ nhật) chưa chắc là đa giác đều.',
        },
      ],
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Không thể có 2 điểm bất động (trừ khi là phép đồng nhất).',
        },
        {
          content: 'Vô số',
          is_correct: false,
    ...
    {
      content:
        'Hình trụ được tạo ra khi quay hình nào sau đây một vòng quanh một cạnh cố định của nó?',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Khi quay một hình tam giác vuông quanh một cạnh góc vuông, nó sẽ tạo ra một hình nón.',
        },
        {
          content: 'Hình chữ nhật.',
          is_correct: true,
          explaination:
            'Theo định nghĩa (Hình 2), hình trụ được tạo ra khi quay một hình chữ nhật một vòng xung quanh đường thẳng cố định chứa một cạnh của nó.',
        },
        {
          content: 'Hình tròn.',
          is_correct: false,
          explaination:
            'Quay một hình tròn quanh một đường kính của nó sẽ tạo ra một hình cầu.',
        },
        {
          content: 'Nửa hình tròn.',
          is_correct: false,
          explaination:
            'Quay một nửa hình tròn quanh đường kính của nó sẽ tạo ra một hình cầu.',
        },
      ],
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Hộp sữa (dạng hộp sữa đặc, sữa bột) thường có dạng hình trụ.',
        },
        {
          content: 'Cốc (ly) thủy tinh (Hình 1c).',
          is_correct: false,
          explaination:
            'Chiếc cốc này có hai đáy hình tròn bằng nhau và thành cốc thẳng đứng, đây là một hình trụ.',
        },
        {
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Đoạn thẳng này gọi là trục của hình trụ, và độ dài của nó bằng chiều cao $h$.',
        },
        {
          content:
            'Mỗi vị trí của cạnh bên khi quay hình chữ nhật tạo thành mặt xung quanh.',
          is_correct: true,
          explaination:
            'Theo định nghĩa (Hình 3), cạnh $AB$ (đối diện cạnh trục quay $CD$) quét nên mặt xung quanh, và mỗi vị trí của $AB$ được gọi là một đường sinh. Độ dài đường sinh bằng chiều cao $h$.',
        },
        {
    ...
    {
      content:
        'Công thức tính diện tích xung quanh $S_{xq}$ của hình trụ có bán kính đáy $r$ và chiều cao $h$ là:',
      explaination:
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Diện tích xung quanh bằng chu vi đáy ($C = 2\\pi r$) nhân với chiều cao ($h$).',
        },
        {
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Đây là công thức tính $S_{tp}$ của hình nón. $S_{tp}$ của hình trụ là $2\\pi rh + 2\\pi r^2$.',
        },
      ],
    },
    {
      content:
        'Công thức tính thể tích $V$ của hình trụ có bán kính đáy $r$ và chiều cao $h$ là:',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Thể tích bằng diện tích đáy ($S = \\pi r^2$) nhân với chiều cao ($h$).',
        },
        {
          content: '$V = 2\\pi r h$',
          is_correct: false,
          explaination:
            'Đây là công thức tính diện tích xung quanh $S_{xq}$ của hình trụ.',
        },
        {
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Đúng, hai mặt đáy (tâm D và tâm C) là hai hình tròn bằng nhau (cùng bán kính $r=DA=CB$).',
        },
        {
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Đúng, trong hình trụ đứng, đường sinh (ví dụ $AB$) song song và bằng trục $CD$, do đó độ dài đường sinh bằng chiều cao $h$.',
        },
        {
          content: 'Độ dài đường sinh bằng bán kính đáy.',
          is_correct: false,
          explaination:
            'Sai, độ dài đường sinh ($h$) không nhất thiết bằng bán kính đáy ($r$), trừ trường hợp đặc biệt $h=r$.',
        },
      ],
    }, // --- Hard ---
    {
      content:
        'Một khối gỗ hình trụ (Ví dụ 3) có bán kính đáy 13 cm và chiều cao 43 cm. Thể tích của khối gỗ đó là (lấy $\\pi \\approx 3,14$, làm tròn đến hàng phần trăm):',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đây là kết quả nếu tính $V = 13 \\times 43 \\times \\pi$. Bạn đã quên bình phương bán kính $r^2$.',
        },
        {
          content: '$22829,95 cm^3$',
          is_correct: true,
          explaination:
            '$V = \\pi \\times (13)^2 \\times 43 = \\pi \\times 169 \\times 43 = 7267\\pi \\approx 7267 \\times 3,14 \\approx 22817,78$. (Sách dùng giá trị $\\pi$ chính xác hơn: $7267\\pi \\approx 22829,95$).',
        },
        {
          content: '$3490,76 cm^3$',
          is_correct: false,
          explaination:
            'Đây là kết quả nếu tính $S_{xq} = 2\\pi rh$. Câu hỏi yêu cầu tính thể tích $V$.',
        },
        {
          content: '$5811,34 cm^3$',
          is_correct: false,
          explaination:
            'Đây là kết quả nếu tính $V = \\pi r h^2$. Bạn đã nhầm lẫn giữa $r$ và $h$ khi bình phương.',
        },
      ],
    },
    {
      content:
        'Một cây cột hình trụ (Bài tập 2) có đường kính đáy 30 cm và chiều cao 350 cm. Chi phí sơn mặt xung quanh là 40 000 đồng/m². Tổng chi phí là (lấy $\\pi \\approx 3,14$, làm tròn đến hàng nghìn):',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            '$S_{xq} = 2 \\times 3,14 \\times 0,15 \\times 3,5 = 3,297 m^2$. Chi phí = $3,297 \\times 40000 = 131880$ đồng. Làm tròn đến hàng nghìn ta được 132 000 đồng.',
        },
        {
          content: '13 188 000 đồng',
          is_correct: false,
          explaination:
            'Sai, có thể bạn đã không đổi đơn vị từ cm sang m và tính $S_{xq}$ bằng cm² ($S_{xq} = 2 \\times 3,14 \\times 15 \\times 350 = 32970 cm^2 = 3.297 m^2$).',
        },
        {
          content: '264 000 đồng',
          is_correct: false,
          explaination:
            'Bạn có thể đã dùng đường kính $d=0.3$m thay vì bán kính $r=0.15$m khi tính $S_{xq}$.',
        },
        {
          content: '9 900 000 đồng',
          is_correct: false,
          explaination:
            'Đây là kết quả nếu tính Thể tích $V = \\pi r^2 h = 3,14 \\times (0.15)^2 \\times 3.5 \\approx 0.247 m^3$ rồi nhân với 40000. Sai yêu cầu (tính $S_{xq}$).',
        },
      ],
    },
    {
      content:
        'Một chiếc pin 3A (Bài tập 6) có dạng hình trụ, cao 44,5 mm và đường kính đáy 10,5 mm. Diện tích toàn phần của viên pin là (lấy $\\pi \\approx 3,14$, làm tròn đến hàng phần mười):',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đây là $S_{xq} = 2 \\times 3,14 \\times 0,525 \\times 4,45 \\approx 14,66 cm^2$. Cần tính $S_{tp}$.',
        },
        {
          content: '$1,7 cm^2$',
          is_correct: false,
          explaination:
            'Đây là diện tích 2 đáy: $2S_{đáy} = 2 \\times 3,14 \\times (0,525)^2 \\approx 1,73 cm^2$. Cần tính $S_{tp}$.',
        },
        {
          content: '$16,4 cm^2$',
          is_correct: true,
          explaination:
            '$S_{xq} \\approx 14,66 cm^2$. $2S_{đáy} \\approx 1,73 cm^2$. $S_{tp} = S_{xq} + 2S_{đáy} \\approx 14,66 + 1,73 = 16,39 cm^2$. Làm tròn đến hàng phần mười là $16,4 cm^2$.',
        },
        {
          content: '$3,9 cm^3$',
          is_correct: false,
          explaination:
            'Đây là Thể tích $V = S_{đáy} \\times h \\approx (1,73/2) \\times 4,45 \\approx 3,85 cm^3$. Sai đơn vị và sai yêu cầu.',
        },
      ],
    },
    {
      content:
        'Một đường ống hình trụ (Bài tập 5) dài 30 m, dung tích 1 800 000 lít. Đường kính đáy của đường ống là (lấy $\\pi \\approx 3,14$, làm tròn đến hàng phần trăm):',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đây là bán kính $r$. $r^2 = 1800 / (3,14 \\times 30) = 1800 / 94,2 \\approx 19,11$. $r = \\sqrt{19,11} \\approx 4,37$ m. Cần tìm đường kính $d$.',
        },
        {
          content: '$19,11 m$',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Ta có $r \\approx 4,37$ m. Đường kính $d = 2r = 2 \\times 4,37 = 8,74$ m.',
        },
        {
          content: '$60 m$',
          is_correct: false,
          explaination:
            'Đây là kết quả của $1800 / 30 = 60$. Bạn đã quên chia cho $\\pi$ và khai căn.',
        },
      ],
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Sai. Phải dùng đường sinh $l$, không dùng chiều cao $h$.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      explaination: 'Áp dụng công thức $S_{xq} = \\pi r l$ với $r=3$ và $l=7$.',
      level: DifficultyLevel.medium,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            '$S_{xq} = \\pi \\times 3 \\times 7 = 21\\pi \\text{ cm}^2$.',
        },
        {
    ...
    }, // --- Hard ---
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Đây mới chỉ là diện tích đáy $S_đ = \\pi \\times 5^2 = 25\\pi$.',
        },
        {
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Bạn đã tính $S_{tp} = \\pi r (h + r) = \\pi \\times 5 \\times (12+5) = 85\\pi$. Sai công thức, phải là $S_{tp} = \\pi r (l + r)$.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Bạn đã tính $\\frac{1}{2} C h = \\frac{1}{2} \\times 12 \\times 2.5 = 15$.',
        },
        {
    ...
    {
      content:
        'Hình nào sau đây được tạo ra khi quay một nửa hình tròn một vòng quanh đường kính cố định của nó?',
      explaination: 'Hãy nhớ lại định nghĩa về cách tạo ra một hình cầu.',
      level: DifficultyLevel.easy,
      type: QuestionType.single_choice,
      accessMode: QuestionAccess.public,
      status: QuestionStatus.ready,
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Hình trụ được tạo ra bằng cách quay một hình chữ nhật.',
        },
        {
          content: 'Hình nón.',
          is_correct: false,
          explaination:
            'Hình nón được tạo ra bằng cách quay một hình tam giác vuông.',
        },
        {
          content: 'Hình cầu.',
          is_correct: true,
          explaination:
            'Theo định nghĩa (Hình 22), khi quay nửa hình tròn tâm O bán kính R một vòng quanh đường kính AB, ta được một hình cầu.',
        },
        {
          content: 'Hình tròn.',
          is_correct: false,
    ...
    {
      content:
        'Khi cắt hình cầu bởi một mặt phẳng, mặt cắt thu được là hình gì?',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Mọi mặt phẳng cắt hình cầu đều tạo ra một mặt cắt là hình tròn. Nếu mặt phẳng đi qua tâm, ta được hình tròn lớn (đường tròn lớn).',
        },
        {
          content: 'Hình elip.',
          is_correct: false,
          explaination:
            'Mặt cắt hình elip xảy ra khi cắt hình nón hoặc hình trụ bởi một mặt phẳng xiên.',
        },
        {
          content: 'Một điểm.',
          is_correct: false,
          explaination:
            'Điều này chỉ xảy ra nếu mặt phẳng tiếp xúc với hình cầu, không cắt qua hình cầu.',
        },
        {
          content: 'Hình vuông.',
          is_correct: false,
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Viên bi là một ví dụ điển hình của vật thể có dạng hình cầu.',
        },
        {
          content: 'Một chiếc đĩa CD.',
          is_correct: false,
          explaination:
            'Chiếc đĩa CD có dạng hình tròn (dẹt), không phải hình cầu (khối tròn).',
        },
      ],
    }, // --- Medium ---
    {
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đây là công thức tính diện tích hình tròn, không phải diện tích mặt cầu.',
        },
        {
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Đây là diện tích của hai mặt đáy hình trụ, hoặc diện tích mặt cầu nếu bạn nhầm lẫn hệ số 4.',
        },
      ],
    },
    {
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Công thức tính thể tích hình cầu là $V = \\frac{4}{3}\\pi R^3$.',
        },
        {
          content: '$V = \\pi R^2 h$',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Bạn đã quên hệ số $\\frac{1}{3}$ trong công thức $\\frac{4}{3}\\pi R^3$.',
        },
      ],
    },
    {
      content:
        'Tính diện tích mặt cầu của một quả bóng (Ví dụ 2) có đường kính 22 cm (lấy $\\pi \\approx 3,14$, làm tròn đến hàng phần mười).',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            '$S = 4 \\times 3,14 \\times (11)^2 = 4 \\times 3,14 \\times 121 = 1519,76 cm^2$. Làm tròn đến hàng phần mười là $1519,8 cm^2$.',
        },
        {
          content: '$379,9 cm^2$',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Bạn có thể đã nhầm lẫn và sử dụng đường kính $d=22$ thay vì bán kính $R=11$ trong công thức: $4 \\times 3,14 \\times (22)^2$.',
        },
        {
          content: '$5572,5 cm^3$',
          is_correct: false,
          explaination:
            'Đây là Thể tích $V = \\frac{4}{3}\\pi R^3$. Câu hỏi yêu cầu tính Diện tích $S$.',
        },
      ],
    }, // --- Hard ---
    {
      content:
        'Một vật thể hình cầu có thể tích là $36\\pi cm^3$. Bán kính $R$ của hình cầu đó là:',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Nếu $R=9$, $V = \\frac{4}{3}\\pi (9)^3 = 972\\pi cm^3$. Bạn có thể đã nhầm $36\\pi = 4\\pi R \\implies R=9$.',
        },
        {
          content: '3 cm',
          is_correct: true,
          explaination:
            'Ta có $36\\pi = \\frac{4}{3}\\pi R^3$. Chia cả hai vế cho $\\pi$: $36 = \\frac{4}{3} R^3$. Suy ra $R^3 = 36 \\times \\frac{3}{4} = 9 \\times 3 = 27$. Vậy $R = \\sqrt[3]{27} = 3$ cm.',
        },
        {
          content: '27 cm',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Nếu $R=6$, $V = \\frac{4}{3}\\pi (6)^3 = 288\\pi cm^3$.',
        },
      ],
    },
    {
      content:
        'Một hình cầu có diện tích mặt cầu là $100\\pi cm^2$. Thể tích $V$ của hình cầu đó là:',
      explaination:
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Từ $S = 4\\pi R^2 = 100\\pi \\implies R^2 = 100/4 = 25 \\implies R = 5$ cm. Thay $R=5$ vào $V$: $V = \\frac{4}{3}\\pi (5)^3 = \\frac{4}{3}\\pi (125) = \\frac{500\\pi}{3} cm^3$.',
        },
        {
          content: '$100\\pi cm^3$',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Bạn có thể đã nhầm lẫn khi tính $R^3$ hoặc hệ số $\\frac{4}{3}$.',
        },
      ],
    },
    {
      content:
        'Một bể bơi hình bán cầu (Bài tập 4) có đường kính 10 m. Tính diện tích bề mặt (gồm cả mặt đáy hình tròn) và thể tích của bể bơi (lấy $\\pi \\approx 3,14$, làm tròn đến hàng phần trăm).',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Bạn đã tính $S = \\frac{1}{2}S_{mặt cầu} = 2\\pi R^2$ (chỉ mặt cong, thiếu mặt đáy) và $V = \\frac{1}{2}V_{hình cầu}$.',
        },
        {
          content: '$S = 314 m^2$; $V = 523,33 m^3$',
          is_correct: false,
          explaination:
            'Đây là diện tích $S$ và thể tích $V$ của CẢ HÌNH CẦU, không phải NỬA HÌNH CẦU.',
        },
        {
          content: '$S = 235,5 m^2$; $V = 261,67 m^3$',
          is_correct: true,
          explaination:
            '$R=5$m. Diện tích bề mặt $S = 3\\pi R^2 = 3 \\times 3,14 \\times (5)^2 = 3 \\times 3,14 \\times 25 = 235,5 m^2$. Thể tích $V = \\frac{2}{3}\\pi R^3 = \\frac{2}{3} \\times 3,14 \\times (5)^3 = \\frac{2}{3} \\times 3,14 \\times 125 \\approx 261,67 m^3$.',
        },
        {
          content: '$S = 235,5 m^2$; $V = 523,33 m^3$',
          is_correct: false,
          explaination:
            'Diện tích $S$ đúng (cho bán cầu + đáy) nhưng thể tích $V$ sai (đây là $V$ của cả hình cầu).',
        },
      ],
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Mặc dù khi nhân ra sẽ thành phương trình bậc hai, nhưng dạng $(...)(...)=0$ có tên gọi cụ thể.',
        },
        {
          content: 'Phương trình tích',
          is_correct: true,
          explaination:
            'Một phương trình có dạng $A(x) \cdot B(x) = 0$ được gọi là phương trình tích.',
        },
        {
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Phương trình bậc nhất chỉ có $x$ với số mũ cao nhất là 1.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Sai dấu ở nghiệm thứ hai. $5x+4=0 \\implies 5x = -4 \\implies x = -4/5$.',
        },
        {
          content: '$x = -7$ hoặc $x = -\\frac{4}{5}$',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Ta giải $x-7=0 \\implies x=7$. Hoặc $5x+4=0 \\implies 5x=-4 \\implies x=-4/5$.',
        },
        {
          content: '$x = -7$ hoặc $x = \\frac{4}{5}$',
          is_correct: false,
    ...
    {
      content:
        'Điều kiện xác định của phương trình $\\frac{3}{3x-2}=\\frac{x}{x+2}-1$ là gì?',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Chưa đủ. Điều kiện này chỉ đảm bảo mẫu $3x-2 \\ne 0$. Cần xét cả mẫu $x+2$.',
        },
        {
          content: '$x \\ne -2$',
          is_correct: false,
          explaination:
            'Chưa đủ. Điều kiện này chỉ đảm bảo mẫu $x+2 \\ne 0$. Cần xét cả mẫu $3x-2$.',
        },
        {
          content: '$x \\ne \\frac{2}{3}$ và $x \\ne -2$',
          is_correct: true,
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'PT $\\iff (x+6)(2x+5) = 0$. Giải $x+6=0 \\implies x=-6$. Giải $2x+5=0 \\implies x=-5/2$.',
        },
        {
          content: '$x = 6$ hoặc $x = \\frac{5}{2}$',
          is_correct: false,
    ...
    {
      content:
        'Tìm nghiệm của phương trình $\\frac{3}{x-2}+\\frac{2}{x+1}=\\frac{2x+5}{(x-2)(x+1)}$.',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            '$x=2$ là nghiệm của phương trình hệ quả $3x=6$, nhưng nó vi phạm ĐKXĐ $x \\ne 2$.',
        },
        {
          content: '$x = -1$',
          is_correct: false,
    ...
    {
      content:
        'Các bước giải phương trình chứa ẩn ở mẫu bao gồm những gì? (Chọn nhiều đáp án)',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Đây là bước đầu tiên và bắt buộc, để loại bỏ các giá trị làm mẫu bằng 0.',
        },
        {
          content: 'Bước 2: Quy đồng mẫu thức hai vế, rồi khử mẫu.',
          is_correct: true,
          explaination:
            'Bước này giúp đưa phương trình về dạng không còn mẫu thức (phương trình hệ quả).',
        },
        {
          content:
            'Bước 3: Giải phương trình vừa nhận được (phương trình hệ quả).',
          is_correct: true,
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Đây là bước quan trọng để loại bỏ các nghiệm ngoại lai (nghiệm vi phạm ĐKXĐ).',
        },
      ],
    }, // --- Hard ---
    {
      content:
        'Độ cao quả bóng gôn là $h=t(20-5t)$. Quả bóng chạm đất (độ cao $h=0$) vào những thời điểm nào?',
      explaination:
      ...
      answers: [
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Giải $t(20-5t) = 0$, ta được $t=0$ (lúc bắt đầu đánh, $h=0$) hoặc $20-5t=0 \\implies 5t=20 \\implies t=4$ (lúc rơi chạm đất, $h=0$).',
        },
        {
          content: 'Chỉ tại $t = 0$ giây',
          is_correct: false,
          explaination:
            'Đây mới là thời điểm ban đầu. Cần tìm cả thời điểm lúc rơi xuống.',
        },
        {
          content: '$t = 5$ giây',
          is_correct: false,
          explaination:
            'Nếu $t=5$, $h = 5(20 - 5 \\times 5) = 5(-5) = -25$, không phải $h=0$.',
        },
      ],
    },
    {
      content:
        'Một ô tô đi từ A đến B rồi quay về A hết 4 giờ 24 phút. Quãng đường AB là 120 km. Tốc độ về lớn hơn tốc độ đi 20%. Tốc độ lúc đi là:',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Giải PT: $\\frac{120}{v} + \\frac{100}{v} = 4.4 \\implies \\frac{220}{v} = 4.4 \\implies v = \\frac{220}{4.4} = 50$. Tốc độ lúc đi là 50 km/h (ĐKXĐ $v>0$ được thoả mãn).',
        },
        {
          content: '60 km/h',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Nếu $v=45$, $t = 120/45 + 120/(1.2 \\times 45) \\approx 2.67 + 2.22 = 4.89$ giờ, không phải 4.4 giờ.',
        },
        {
          content: '55 km/h',
          is_correct: false,
          explaination:
            'Nếu $v=55$, $t = 120/55 + 120/(1.2 \\times 55) \\approx 2.18 + 1.82 = 4$ giờ, không phải 4.4 giờ.',
        },
      ],
    ...
    {
      content: 'Cặp số $(1; 2)$ là nghiệm của hệ phương trình nào sau đây?',
      explaination:
    ...
    },
    {
      ...
      answers: [
        ...
        },
        {
          content: '$2y - 2x = 210$',
          is_correct: false,
          explaination: 'Đây là hiệu quãng đường. Phải là tổng quãng đường.',
        },
      ],
    },
    {
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Đây là tính chất cơ bản của phương trình bậc nhất hai ẩn.',
        },
        {
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Sai. Phương trình bậc nhất một ẩn mới có 1 nghiệm duy nhất.',
        },
        {
          content: 'Luôn vô nghiệm.',
          is_correct: false,
          explaination:
            'Sai. Chỉ phương trình $0x+0y=c$ (với $c \\ne 0$) mới vô nghiệm.',
        },
      ],
    }, // --- Hard ---
    {
    ...
    },
    {
      ...
      answers: [
        {
          content:
            '$\\begin{cases} x - y = 15 \\\\ 2x + 2y = 210 \\end{cases}$',
          is_correct: true,
          explaination:
        ...
        {
          content:
            '$\\begin{cases} y - x = 15 \\\\ 2x + 2y = 210 \\end{cases}$',
          is_correct: false,
        ...
        {
          content:
            '$\\begin{cases} x = y + 15 \\\\ 210/x = 210/y + 2 \\end{cases}$',
          is_correct: false,
          explaination:
    ...
    {
      content:
        'Bước đầu tiên của việc giải hệ phương trình bằng phương pháp thế là gì?',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Đây là bước của phương pháp cộng đại số, không phải phương pháp thế.',
        },
        {
          content: 'Từ một phương trình, biểu diễn ẩn này theo ẩn kia.',
          is_correct: true,
          explaination:
            'Đây là Bước 1 của phương pháp thế. Ví dụ, từ $x - 2y = 1$, ta biểu diễn $x$ theo $y$ thành $x = 2y + 1$.',
        },
        {
          content: 'Nhân hai vế của một phương trình với một số.',
          is_correct: false,
          explaination:
            'Đây là một bước có thể có trong phương pháp cộng đại số, không phải là bước đầu tiên của phương pháp thế.',
        },
        {
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Mục tiêu của mọi phương pháp giải là làm cho bài toán đơn giản hơn.',
        },
        {
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Bằng cách cộng hoặc trừ, ta làm cho hệ số của một ẩn (ví dụ $y$ và $-y$) triệt tiêu, chỉ còn lại phương trình chứa ẩn $x$.',
        },
        {
          content: 'Tìm ra $x=0$ và $y=0$.',
          is_correct: false,
          explaination:
            'Đây chỉ là một nghiệm có thể có, không phải mục tiêu của phương pháp.',
        },
      ],
    },
    {
      content:
        'Giải hệ phương trình $\\begin{cases}x = 3y + 1 \\\\ 2x + y = 9\\end{cases}$',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Thế (1) vào (2): $2(3y+1) + y = 9 \\implies 6y+2+y=9 \\implies 7y=7 \\implies y=1$. Thay $y=1$ vào (1): $x = 3(1) + 1 = 4$.',
        },
        {
          content: '$x = 1, y = 4$',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Nếu $y=2$, $x = 3(2)+1 = 7$. Nhưng $2(7)+2 = 16$, không bằng 9. Sai.',
        },
        {
          content: '$x = -2, y = -1$',
          is_correct: false,
    ...
    {
      content:
        'Giải hệ phương trình $\\begin{cases}2x-3y=-5 \\\\ x+3y=11\\end{cases}$',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Lấy (1) + (2) vế theo vế: $(2x-3y) + (x+3y) = -5 + 11 \\implies 3x = 6 \\implies x=2$. Thế $x=2$ vào (2): $2 + 3y = 11 \\implies 3y = 9 \\implies y=3$.',
        },
        {
          content: '$x = 3, y = 2$',
          is_correct: false,
        ...
        },
        {
          ...
          is_correct: false,
          explaination:
            'Kiểm tra lại: $2(-1) - 3(1) = -5$ (Đúng). Nhưng $(-1) + 3(1) = 2$, không bằng 11. Sai.',
        },
        {
          content: '$x = 16, y = -5$',
          is_correct: false,
    ...
    {
      content:
        'Giải hệ phương trình $\\begin{cases}x-2y=4 \\\\ 2x-4y=1\\end{cases}$',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Cặp số này thỏa mãn (1) nhưng không thỏa mãn (2): $2(4) - 4(0) = 8 \\ne 1$.',
        },
        {
        ...
        },
        {
          ...
          is_correct: true,
          explaination:
            'Thế $x = 2y + 4$ vào (2): $2(2y+4) - 4y = 1 \\implies 4y + 8 - 4y = 1 \\implies 0y = -7$. Phương trình này vô nghiệm, do đó hệ vô nghiệm.',
        },
        {
          content: '$x = 2, y = -1$',
          is_correct: false,
          explaination:
            'Cặp số này thỏa mãn (1) nhưng không thỏa mãn (2): $2(2) - 4(-1) = 8 \\ne 1$.',
        },
      ],
    },
    {
      content:
        'Kết luận nào đúng cho hệ phương trình $\\begin{cases}3x+y=2 \\\\ 6x+2y=4\\end{cases}$?',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: false,
          explaination:
            'Cặp số (0, 2) thỏa mãn cả hai phương trình, nhưng đây không phải là nghiệm *duy nhất*.',
        },
        {
          content: 'Hệ phương trình vô nghiệm.',
          is_correct: false,
          explaination:
            'Trường hợp vô nghiệm xảy ra khi $0x = k$ với $k \\ne 0$.',
        },
        {
          content: 'Hệ phương trình có vô số nghiệm.',
          is_correct: true,
          explaination:
            'Thế $y = 2 - 3x$ vào (2): $6x + 2(2 - 3x) = 4 \\implies 6x + 4 - 6x = 4 \\implies 0x = 0$. Phương trình này nghiệm đúng với mọi $x$. Vậy hệ có vô số nghiệm dạng $\\begin{cases}x \\in \\mathbb{R} \\\\ y = 2 - 3x\\end{cases}$.',
        },
        {
          content: 'Hệ có nghiệm duy nhất $x=1, y=-1$.',
          is_correct: false,
          explaination:
            'Cặp số (1, -1) thỏa mãn cả hai phương trình, nhưng đây không phải là nghiệm *duy nhất*.',
        },
      ],
    },
    {
      content:
        'Các bước giải bài toán bằng cách lập hệ phương trình là gì? (Chọn nhiều đáp án)',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Bao gồm chọn ẩn, đặt điều kiện, và lập các phương trình từ giả thiết.',
        },
        {
          content: 'Bước 2: Giải hệ phương trình nhận được.',
          is_correct: true,
          explaination:
            'Sử dụng các phương pháp như thế hoặc cộng đại số để tìm giá trị của các ẩn.',
        },
        {
          content: 'Bước 3: Kiểm tra nghiệm với điều kiện và trả lời bài toán.',
          is_correct: true,
          explaination:
            'Kiểm tra xem nghiệm tìm được có hợp lý không (ví dụ: số người không thể âm) và trả lời câu hỏi của bài toán.',
        },
        {
          content: 'Bước 4: Vẽ đồ thị của hệ phương trình.',
          is_correct: false,
          explaination:
            'Việc vẽ đồ thị là một phương pháp giải (phương pháp đồ thị), không phải là một bước bắt buộc trong quy trình giải chung.',
        },
      ],
    }, // --- Hard ---
    {
      content:
        'Bài toán mở đầu: Chị An mua 1,2kg thịt lợn và 0,7kg thịt bò hết 362 nghìn. Chị Ba mua 0,8kg lợn và 0,5kg bò hết 250 nghìn. Hệ phương trình nào mô tả đúng bài toán?',
      explaination:
      ...
      answers: [
        {
          content:
            '$\\begin{cases}1.2x + 0.7y = 362 \\\\ 0.8x + 0.5y = 250\\end{cases}$',
          is_correct: true,
          explaination:
            'PT (1): 1,2kg lợn ($1.2x$) + 0,7kg bò ($0.7y$) = 362. PT (2): 0,8kg lợn ($0.8x$) + 0,5kg bò ($0.5y$) = 250.',
        },
        {
          content:
            '$\\begin{cases}1.2x + 0.8y = 362 \\\\ 0.7x + 0.5y = 250\\end{cases}$',
          is_correct: false,
          explaination:
            'Sai. Phương trình đã trộn lẫn số liệu của chị An và chị Ba.',
        },
        {
          content: '$\\begin{cases}x + y = 362 \\\\ x + y = 250\\end{cases}$',
          is_correct: false,
          explaination:
            'Sai. Đây là phương trình nếu coi $x$ và $y$ là tổng số kg thịt, không phải giá tiền.',
        },
        {
          content:
            '$\\begin{cases}0.7x + 1.2y = 362 \\\\ 0.5x + 0.8y = 250\\end{cases}$',
          is_correct: false,
    ...
    {
      content:
        'Tìm $a$ và $b$ để đồ thị hàm số $y=ax+b$ đi qua hai điểm $A(2; -2)$ và $B(-1; 3)$.',
      explaination:
      ...
      answers: [
        {
          ...
          is_correct: true,
          explaination:
            'Ta có hệ $\\begin{cases}2a+b=-2 \\\\ -a+b=3\\end{cases}$. Lấy (1) - (2): $3a = -5 \\implies a = -5/3$. Thế vào (2): $-(-5/3) + b = 3 \\implies 5/3 + b = 9/3 \\implies b = 4/3$.',
        },
        {
          content: '$a = 1, b = -4$',
          is_correct: false,
          explaination:
            'Nếu $a=1, b=-4$, điểm A(2, -2) thỏa mãn: $1(2) - 4 = -2$. Nhưng điểm B(-1, 3) không thỏa: $1(-1) - 4 = -5 \\ne 3$.',
        },
        {
          content: '$a = 1, b = 1$',
          is_correct: false,
          explaination:
            'Nếu $a=1, b=1$, điểm A(2, -2) không thỏa mãn: $1(2) + 1 = 3 \\ne -2$.',
        },
        {
          content: '$a = -\\frac{4}{3}, b = \\frac{5}{3}$',
          is_correct: false,
          explaination:
            'Tính toán sai khi giải hệ. $3a = -5$, không phải $3a = -4$.',
        },
      ],
    },
  ];
  ...
  console.log(
    `Seeding Questions và Answers hoàn tất. Đã tạo: ${createdCount}, Đã bỏ qua (trùng): ${skippedCount}.`,
  );
}
