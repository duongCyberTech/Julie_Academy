...
-- CreateEnum
CREATE TYPE "QuestionAccess" AS ENUM ('private', 'public');

-- CreateEnum
CREATE TYPE "ExamType" AS ENUM ('practice', 'test', 'final');

-- CreateEnum
CREATE TYPE "PlanType" AS ENUM ('book', 'custom');
...
CREATE TABLE "Questions" (
    ...
    "accessMode" "QuestionAccess" NOT NULL DEFAULT 'private',
    "title" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Lesson_Plan_title_key" ON "Lesson_Plan"("title");
...
-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "Student"("uid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Claim" ADD CONSTRAINT "Claim_badge_id_fkey" FOREIGN KEY ("badge_id") REFERENCES "Badge"("badge_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Claim" ADD CONSTRAINT "Claim_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "Student"("uid") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Class" ADD CONSTRAINT "Class_plan_id_fkey" FOREIGN KEY ("plan_id") REFERENCES "Lesson_Plan"("plan_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Resources" ADD CONSTRAINT "Resources_cate_id_fkey" FOREIGN KEY ("cate_id") REFERENCES "Categories"("category_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Folders" ADD CONSTRAINT "Child_folder_fkey" FOREIGN KEY ("parent_id") REFERENCES "Folders"("folder_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "Folders" ADD CONSTRAINT "Folders_cate_id_fkey" FOREIGN KEY ("cate_id") REFERENCES "Categories"("category_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Categories" ADD CONSTRAINT "fk_recursive_cate" FOREIGN KEY ("parent_id") REFERENCES "Categories"("category_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "Questions" ADD CONSTRAINT "Questions_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "Categories"("category_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Lesson_Plan" ADD CONSTRAINT "Lesson_Plan_tutor_id_fkey" FOREIGN KEY ("tutor_id") REFERENCES "Tutor"("uid") ON DELETE SET NULL ON UPDATE CASCADE;
